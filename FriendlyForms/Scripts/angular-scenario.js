...
jQuery.support = (function() {
	...
	div.innerHTML = "  <link/><table></table><a href='/a'>a</a><div class="col-lg-4"><input class="form-control" type='checkbox'/>";
...
if ( document.querySelectorAll ) {
	(function() {
		...
		assert(function( div ) {
			...
			// IE8 throws error here (do not put tests after this one)
			div.innerHTML = "<div class="col-lg-4"><input class="form-control" type='hidden'/>";
