...
;var CourtCtrl=function(a,b,c,d,e,f,g){a.path=c.path(),a.showErrors=!1,a.courts=d.courts.get({UserId:b.userId},function(){if(typeof a.courts.Id=="undefined"||a.courts.Id==0)a.courts=$.jStorage.get(a.path),a.courts&&(a.showErrors=!0)}),d.counties.get({},function(b){a.counties=b.Counties}),a.submit=function(c){if(a.courtForm.$invalid){e.setSubMenuIconClass(a.path,"icon-pencil icon-red");var g=f.getFormInput("#courtForm");$.jStorage.set(a.path,g),c||e.nextMenu();return}$.jStorage.deleteKey(a.path),a.courts.UserId=b.userId,typeof a.courts.Id=="undefined"||a.courts.Id==0?d.courts.save(null,a.courts,function(){e.setSubMenuIconClass(a.path,"icon-ok icon-green"),c||e.nextMenu()}):d.courts.update({Id:a.courts.Id},a.courts,function(){e.setSubMenuIconClass(a.path,"icon-ok icon-green"),c||e.nextMenu()})},f.refreshPage(function(){g.currentScope=a})};CourtCtrl.$inject=["$scope","$routeParams","$location","courtService","menuService","genericService","$rootScope"]
;FormsApp.factory("courtService",["$resource",function(a){var b={courts:a("/api/court/:userId",{userId:"@userId"},{get:{method:"GET",params:{format:"json"}},update:{method:"PUT",params:{format:"json"}}}),counties:a("/api/Counties",{},{get:{method:"GET",params:{format:"json"}},update:{method:"PUT",params:{format:"json"}}})};return b}])
...
;var CreateClientCtrl=["$scope","$routeParams","$location","clientService","courtService","headerService","userService",function(a,b,c,d,e,f,g){a.submit=function(){if(a.createClientForm.$invalid)return;a.user.Email.indexOf(!1)&&(a.user.Email=a.user.Email+"@ourlawfirm.com"),g.register.save(null,a.user,function(f){var g={UserId:f.UserId,County:0,CaseNumber:a.courts.CaseNumber,AuthorOfPlan:1,PlanType:1},h={UserId:b.userId,ClientUserId:f.UserId};d.clients.save(null,h,function(){e.courts.save(null,g,function(){c.path("/Attorney/Case/"+h.ClientUserId)})})})},f.setTitle("Create A Client")}]
