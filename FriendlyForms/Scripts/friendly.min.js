...
;window.Friendly=window.Friendly||{},Friendly.properties={messageType:{Warning:"",Success:"alert-success",Error:"alert-error"},numberRegEx:/(\d{1,5})/},Friendly.StartLoading=function(){$("#loading").show(),$("body").css("cursor","wait")},Friendly.EndLoading=function(){$("#loading").hide(),$("body").css("cursor","default")},Friendly.ShowMessage=function(a,b,c,d){Friendly.EndLoading(),c=typeof c=="undefined"?Friendly.properties.messageType.Warning:c;var e={Title:a,Message:b,AlertType:c},f=$("#friendly-message-template").tmpl(e);typeof d=="undefined"&&(d="#main-content"),$(d).prepend(f)},Friendly.GenericErrorMessage=function(a,b,c){Friendly.EndLoading();if(a.responseText!=""&&a.responseText[0]!="<"){var d=JSON.parse(a.responseText);if(c==="Bad Request")return Friendly.ShowMessage("Input Error",d.ResponseStatus.Message,Friendly.properties.messageType.Error),!1}return Friendly.ShowMessage("Sorry!","We could not process your request.  The error has been logged and we will do our best to correct the error asap.",Friendly.properties.messageType.Error),!1},Friendly.SubmitForm=function(a,b,c){Friendly.StartLoading(),typeof c=="undefined"&&(c=Friendly.GetFormInput(a));var d="#"+a;if($(d).valid())$.ajax({url:"/Forms/"+a+"/",type:"POST",data:c,success:function(){return Friendly.NextForm(b),Friendly.EndLoading(),!1},error:Friendly.GenericErrorMessage});else return Friendly.EndLoading(),!1;return!1},Friendly.SubmitFormOther=function(a,b,c){Friendly.StartLoading(),typeof c=="undefined"&&(c=Friendly.GetFormInput(a)),c.isOtherParent="true";var d="#"+a,e=a.substring(0,a.indexOf("Other"));if($(d).valid())$.ajax({url:"/Forms/"+e+"/",type:"POST",data:c,success:function(){return Friendly.NextForm(b),Friendly.EndLoading(),!1},error:Friendly.GenericErrorMessage});else return Friendly.EndLoading(),!1;return!1},Friendly.NextForm=function(a){$("#sidebar .active").find("i").attr("class","icon-ok"),$("#"+a+"Nav").find("i").attr("class","icon-pencil"),$(".wrapper").hide(),$("#sidebar li").removeClass("active"),$("#"+a+"Wrapper").show(),$("#"+a+"Nav").addClass("active"),a==="preexistingOther"&&$('#preexistingOther input[id="PreexistingSupportViewModel_Support"]:checked').val()==="1"&&$("#supportOtherWrapper").show()},Friendly.GetFormInput=function(a){var b={};return $.each($("#"+a).serializeArray(),function(a,c){c.name.indexOf(".")>=0&&(c.name=c.name.substring(c.name.indexOf(".")+1,c.name.length)),b[c.name]=c.value}),b},Friendly.ClearForm=function(a){$(":input","#"+a).not(":button, :submit, :reset, :hidden, :radio").val("").removeAttr("selected"),$(":input","#"+a).not(":button, :submit, :reset, :hidden,").removeAttr("checked").removeAttr("selected")},$(document).ready(function(){$(".hoverHelp").popover({placement:"left",title:"Tip",trigger:"hover"}),$.validator.addMethod("textlineinput",function(a,b,c){return this.optional(b)?!0:a.split("\\")[0]===c}),$.validator.unobtrusive.adapters.add("textlineinput",["name"],function(a){a.rules.textlineinput=a.params.name,a.message&&(a.messages.textlineinput=a.message)});var a=$("form"),b=[],c=[],d=[];for(var e=0;e<a.length;e++){var f=$.data(a[e],"validator").settings;b[e]=f.errorPlacement,c[e]=f.success,d[e]=f.invalidHandler,f.formNdx=e,f.errorPlacement=function(c,d){$(d).closest(".control-group").addClass("error"),!!$.data(a[this.formNdx],"validator").valid(),b[this.formNdx](c,d)},f.success=function(a){$(a).closest(".control-group").removeClass("error"),c[this.formNdx](a)},f.invalidHandler=function(a){d[this.formNdx]()}}$(".datepicker").datepicker(),$(".timepicker").timepicker({minuteStep:15,showInputs:!1,disableFocus:!0}),$("#main-content").on("click",".close",function(){$(this).parent().parent().parent().remove()}),$(".nav-item").click(function(){var a=$(this).children(":first-child").attr("data-form");Friendly.NextForm(a)})})
;$(document).ready(function(){$(".domestic-part1").click(function(){var a={Address:$("#Address").val(),Equity:$("#Equity").val().replace(",",""),MaritalHouse:$("#MaritalHouse:checked").val(),MoneyOwed:$("#MoneyOwed").val().replace(",",""),MortgageOwner:$("#MortgageOwner").val(),RetailValue:$("#RetailValue").val().replace(",","")};Friendly.SubmitForm("maritalHouse","property",a)}),$("input[name=MaritalHouse]").change(function(){$(".marital-info").val(""),$("#MaritalHouse:checked").val()==="1"?$(".marital-house").show():$(".marital-house").hide()}),$(".domestic-part2").click(function(){$(this).hasClass("next")&&Friendly.SubmitForm("property","vehicles"),$(this).hasClass("previous")&&Friendly.SubmitForm("property","maritalHouse")}),$("input[name=RealEstate]").change(function(){$("#RealEstateDescription").val(""),$("#RealEstate:checked").val()==="1"?$(".real-estate-details").show():$(".real-estate-details").hide()}),$("input[name=PersonalProperty]").change(function(){$("#DividingProperty").val(""),$("#PersonalProperty:checked").val()==="3"?$(".property-details").show():$(".property-details").hide()}),$("#addVehicle").click(function(){Friendly.StartLoading();if(!$("#vehicles").valid())return Friendly.EndLoading(),!1;var a=Friendly.GetFormInput("vehicles");return $.ajax({url:"/Forms/Vehicles/",type:"POST",data:a,success:function(a){$(".vehicle-table").show();var b=$("#friendly-vehicle-template").tmpl(a);return $(".vehicle-table tbody").append(b),Friendly.ClearForm("vehicles"),Friendly.EndLoading(),!1},error:Friendly.GenericErrorMessage}),!1}),$(".domestic-part3").click(function(){return $(this).hasClass("next")&&Friendly.NextForm("debt"),$(this).hasClass("previous")&&Friendly.NextForm("property"),Friendly.EndLoading(),!1}),$(".domestic-part4").click(function(){var a={DebtDivision:$("#DebtDivision").val(),MaritalDebt:$("#MaritalDebt:checked").val()};$(this).hasClass("next")&&Friendly.SubmitForm("debt","assets",a),$(this).hasClass("previous")&&Friendly.SubmitForm("debt","vehicles",a)}),$("input[name=MaritalDebt]").change(function(){$("#DebtDivision").val(""),$("#MaritalDebt:checked").val()==="1"?$(".debt-details").show():$(".debt-details").hide()}),$(".domestic-part5").click(function(){$(this).hasClass("next")&&Friendly.SubmitForm("assets","healthInsurance"),$(this).hasClass("previous")&&Friendly.SubmitForm("assets","debt")}),$("input[name=Retirement]").change(function(){$("#RetirementDescription").val(""),$("#Retirement:checked").val()==="2"?$(".retirement-detail").show():$(".retirement-detail").hide()}),$("input[name=NonRetirement]").change(function(){$("#NonRetirementDescription").val(""),$("#NonRetirement:checked").val()==="2"?$(".non-retirement-detail").show():$(".non-retirement-detail").hide()}),$("input[name=Business]").change(function(){$("#BusinessDescription").val(""),$("#Business:checked").val()==="2"?$(".business-detail").show():$(".business-detail").hide()}),$(".domestic-part6").click(function(){$(this).hasClass("next")&&Friendly.SubmitForm("healthInsurance","spousalSupport"),$(this).hasClass("previous")&&Friendly.SubmitForm("healthInsurance","assets")}),$("input[name=Health]").change(function(){$("#HealthDescription").val(""),$("#Health:checked").val()==="2"?$(".health-detail").show():$(".health-detail").hide()}),$(".domestic-part7").click(function(){$(this).hasClass("next")&&Friendly.SubmitForm("spousalSupport","taxes"),$(this).hasClass("previous")&&Friendly.SubmitForm("spousalSupport","healthInsurance")}),$("input[name=Spousal]").change(function(){$("#SpousalDescription").val(""),$("#Spousal:checked").val()==="2"?$(".spousal-detail").show():$(".spousal-detail").hide()}),$(".domestic-part8").click(function(){$(this).hasClass("next")&&Friendly.SubmitForm("taxes","support"),$(this).hasClass("previous")&&Friendly.SubmitForm("taxes","spousalSupport")}),$("input[name=Taxes]").change(function(){$("#TaxDescription").val(""),$("#Taxes:checked").val()==="2"?$(".taxes-detail").show():$(".taxes-detail").hide()}),$(".domestic-part9").click(function(){var a={PaidBy:$("#PaidBy").val(),PaidTo:$("#PaidTo").val(),MonthlyAmount:$("#MonthlyAmount:checked").val(),EffectiveDate:$("#EffectiveDate").val(),TemporaryAgreement:$("#TemporaryAgreement:checked").val(),Payment:$("#Payment:checked").val(),PaymentDay:$("#PaymentDay").val()};$(this).hasClass("previous")&&Friendly.SubmitForm("support","taxes",a)}),$("input[name=Payment]").change(function(){$("#PaymentDay").val(""),$("#Payment:checked").val()==="2"?$(".support-payday").show():$(".support-payday").hide()})})
;$(document).ready(function(){$(".financial-part1").click(function(){var a=Friendly.GetFormInput("income");Friendly.SubmitForm("income","socialSecurity",a)}),$('#income input[name="Employed"]').change(function(){$("#income #Salary").val(""),$("#income #Employed:checked").val()==="1"?$("#income .income-employed").show():$("#income .income-employed").hide()}),$('#income input[name="SelfEmployed"]').change(function(){$("#income #SelfIncome").val(""),$("#income #SelfEmployed:checked").val()==="1"?$("#income .income-self").show():$("#income .income-self").hide()}),$('#income input[name="SelfTax"]').change(function(){$("#income #SelfTaxAmount").val(""),$("#income #SelfTax:checked").val()==="1"?$("#income .income-tax").show():$("#income .income-tax").hide()}),$('#income input[name="OtherSources"]').change(function(){$("#income #OtherSources:checked").val()==="1"?$("#income .income-other").show():$("#income .income-other").hide()}),$(".financial-part2").click(function(){var a=Friendly.GetFormInput("socialSecurity");$(this).hasClass("next")&&Friendly.SubmitForm("socialSecurity","preexisting",a),$(this).hasClass("previous")&&Friendly.SubmitForm("socialSecurity","income",a)}),$('#socialSecurity input[name="ReceiveSocial"]').change(function(){$("#socialSecurity #Amount").val(""),$("#socialSecurity #ReceiveSocial:checked").val()==="1"?$("#socialSecurity .social-social").show():$("#socialSecurity .social-social").hide()}),$(".preexisting-item").click(function(){Friendly.NextForm("preexisting"),$('#preexisting input[id="PreexistingSupportViewModel_Support"]:checked').val()==="1"&&$("#supportWrapper").show()}),$('#preexisting input[id="PreexistingSupportViewModel_Support"]').change(function(){$('#preexisting input[id="PreexistingSupportViewModel_Support"]:checked').val()==="1"?$("#supportWrapper").show():$("#supportWrapper").hide()}),$("#addSupport").click(function(){Friendly.StartLoading();var a=Friendly.GetFormInput("support");$("#support").valid()&&$.ajax({url:"/Forms/AddSupport",type:"POST",data:a,success:function(a){var b=$("#friendly-support-template").tmpl(a);$("#supportWrapper .support-table tbody").append(b),Friendly.ClearForm("support"),Friendly.EndLoading()},error:Friendly.GenericErrorMessage}),Friendly.EndLoading()}),$("#supportWrapper table").on("click",".view-children",function(){var a=$(this).attr("data-id");$.ajax({url:"/Forms/GetChildSupport",type:"POST",data:{Id:a},success:function(b){if(b.length!==0){$("#childWrapper .child-table tbody").empty();var c=$("#friendly-childsupport-template").tmpl(b);$("#childWrapper .child-table tbody").append(c),$("#childWrapper .child-table").show()}else $("#childWrapper .child-table").hide();$("#childWrapper #supportId").val(a),$("#childWrapper").show()},error:Friendly.GenericErrorMessage})}),$("#addChildSupport").click(function(){Friendly.StartLoading();var a=Friendly.GetFormInput("child");a.PreexistingSupportId=$("#childWrapper #supportId").val(),$("#child").valid()&&$.ajax({url:"/Forms/AddChildSupport",type:"POST",data:a,success:function(a){var b=$("#friendly-childsupport-template").tmpl(a);$("#childWrapper .child-table tbody").append(b),$("#childWrapper .child-table").show(),Friendly.ClearForm("child"),Friendly.EndLoading()},error:Friendly.GenericErrorMessage}),Friendly.EndLoading()}),$(".financial-part3").click(function(){$(this).hasClass("next")&&Friendly.NextForm("otherChild"),$(this).hasClass("previous")&&Friendly.NextForm("socialSecurity")}),$(".financial-part4").click(function(){if($(this).hasClass("next")&&$("#otherChildWrapper").is(":visible"))return Friendly.NextForm("circumstance"),!1;if($(this).hasClass("previous")&&$("#otherChildWrapper").is(":visible"))return Friendly.NextForm("preexisting"),!1;Friendly.StartLoading();var a=Friendly.GetFormInput("otherChildren");$("#otherChildren").valid()&&$.ajax({url:"/Forms/OtherChildren/",type:"POST",data:a,success:function(b){a.LegallyResponsible==="1"&&a.AtHome==="1"&&a.Support==="1"&&a.Preexisting==="2"&&a.InCourt==="2"?($("#otherChildWrapper #childrenId").val(b.Id),$("#otherChildWrapper").show()):Friendly.NextForm("circumstance"),Friendly.EndLoading()},error:Friendly.GenericErrorMessage}),Friendly.EndLoading()}),$("#addOtherChild").click(function(){Friendly.StartLoading();var a=Friendly.GetFormInput("otherchild");a.OtherChildrenId=$("#otherChildWrapper #childrenId").val(),$("#otherChildren").valid()&&$.ajax({url:"/Forms/AddOtherChild/",type:"POST",data:a,success:function(a){var b=$("#friendly-childsupport-template").tmpl(a);$("#otherChildWrapper .otherChild-table tbody").append(b),$("#otherChildWrapper .otherChild-table").show(),Friendly.ClearForm("otherchild"),Friendly.EndLoading()},error:Friendly.GenericErrorMessage}),Friendly.EndLoading()}),$(".financial-part5").click(function(){var a=Friendly.GetFormInput("circumstance");$(this).hasClass("next")&&Friendly.SubmitForm("circumstance","incomeOther",a),$(this).hasClass("previous")&&Friendly.SubmitForm("circumstance","otherChildren",a)}),$('input[name="Circumstances"]').change(function(){$("#Circumstances:checked").val()==="1"?$(".circumstance-other").show():$(".circumstance-other").hide()}),$('#incomeOther input[name="Employed"]').change(function(){$("#incomeOther #Salary").val(""),$("#incomeOther #Employed:checked").val()==="1"?$("#incomeOther .income-employed").show():$("#incomeOther .income-employed").hide()}),$('#incomeOther input[name="SelfEmployed"]').change(function(){$("#incomeOther #SelfIncome").val(""),$("#incomeOther #SelfEmployed:checked").val()==="1"?$("#incomeOther .income-self").show():$("#incomeOther .income-self").hide()}),$('#incomeOther input[name="SelfTax"]').change(function(){$("#incomeOther #SelfTaxAmount").val(""),$("#incomeOther #SelfTax:checked").val()==="1"?$("#incomeOther .income-tax").show():$("#incomeOther .income-tax").hide()}),$('#incomeOther input[name="OtherSources"]').change(function(){$("#incomeOther #OtherSources:checked").val()==="1"?$("#incomeOther .income-other").show():$("#incomeOther .income-other").hide()}),$(".financial-part6").click(function(){$(this).hasClass("next")&&Friendly.SubmitFormOther("incomeOther","socialSecurityOther"),$(this).hasClass("previous")&&Friendly.SubmitFormOther("incomeOther","circumstance")}),$(".financial-part7").click(function(){$(this).hasClass("next")&&Friendly.SubmitFormOther("socialSecurityOther","preexistingOther"),$(this).hasClass("previous")&&Friendly.SubmitFormOther("socialSecurityOther","incomeOther")}),$('#socialSecurityOther input[name="ReceiveSocial"]').change(function(){$("#socialSecurityOther #Amount").val(""),$("#socialSecurityOther #ReceiveSocial:checked").val()==="1"?$("#socialSecurityOther .social-social").show():$("#socialSecurityOther .social-social").hide()}),$(".preexistingOther-item").click(function(){Friendly.NextForm("preexistingOther"),$('#preexistingOther input[id="PreexistingSupportViewModel_Support"]:checked').val()==="1"&&$("#supportOtherWrapper").show()}),$('#preexistingOther input[id="PreexistingSupportViewModel_Support"]').change(function(){$('#preexistingOther input[id="PreexistingSupportViewModel_Support"]:checked').val()==="1"?$("#supportOtherWrapper").show():$("#supportOtherWrapper").hide()}),$("#addSupportOther").click(function(){Friendly.StartLoading();var a=Friendly.GetFormInput("supportOther");a.IsOtherParent="true",$("#supportOther").valid()&&$.ajax({url:"/Forms/AddSupport",type:"POST",data:a,success:function(a){var b=$("#friendly-support-template").tmpl(a);$("#supportOtherWrapper .support-table tbody").append(b),Friendly.ClearForm("supportOther"),Friendly.EndLoading()},error:Friendly.GenericErrorMessage}),Friendly.EndLoading()}),$("#supportOtherWrapper table").on("click",".view-children",function(){var a=$(this).attr("data-id");$.ajax({url:"/Forms/GetChildSupport",type:"POST",data:{Id:a},success:function(b){if(b.length!==0){$("#childOtherWrapper .child-table tbody").empty();var c=$("#friendly-childsupport-template").tmpl(b);$("#childOtherWrapper .child-table tbody").append(c),$("#childOtherWrapper .child-table").show()}else $("#childOtherWrapper .child-table").hide();$("#childOtherWrapper #supportId").val(a),$("#childOtherWrapper").show()},error:Friendly.GenericErrorMessage})}),$("#addChildSupportOther").click(function(){Friendly.StartLoading();var a=Friendly.GetFormInput("childOther");a.PreexistingSupportId=$("#childOtherWrapper #supportId").val(),a.IsOtherParent="true",$("#childOther").valid()&&$.ajax({url:"/Forms/AddChildSupport",type:"POST",data:a,success:function(a){var b=$("#friendly-childsupport-template").tmpl(a);$("#childOtherWrapper .child-table tbody").append(b),$("#childOtherWrapper .child-table").show(),Friendly.ClearForm("childOther"),Friendly.EndLoading()},error:Friendly.GenericErrorMessage}),Friendly.EndLoading()}),$(".financial-part8").click(function(){$(this).hasClass("next")&&Friendly.NextForm("otherChildrenOther"),$(this).hasClass("previous")&&Friendly.NextForm("socialSecurityOther")}),$(".financial-part9").click(function(){if($(this).hasClass("next")&&$("#otherChildOtherWrapper").is(":visible"))return Friendly.NextForm("circumstanceOther"),!1;if($(this).hasClass("previous")&&$("#otherChildOtherWrapper").is(":visible"))return Friendly.NextForm("preexisting"),!1;Friendly.StartLoading();var a=Friendly.GetFormInput("otherChildrenOther");a.IsOtherParent="true",$("#otherChildrenOther").valid()&&$.ajax({url:"/Forms/OtherChildren/",type:"POST",data:a,success:function(b){a.LegallyResponsible==="1"&&a.AtHome==="1"&&a.Support==="1"&&a.Preexisting==="2"&&a.InCourt==="2"?($("#otherChildOtherWrapper #childrenId").val(b.Id),$("#otherChildOtherWrapper").show()):Friendly.NextForm("circumstanceOther"),Friendly.EndLoading()},error:Friendly.GenericErrorMessage}),Friendly.EndLoading()}),$("#addOtherChildOther").click(function(){Friendly.StartLoading();var a=Friendly.GetFormInput("otherchildOther");a.OtherChildrenId=$("#otherChildOtherWrapper #childrenId").val(),$("#otherchildOther").valid()&&$.ajax({url:"/Forms/AddOtherChild/",type:"POST",data:a,success:function(a){var b=$("#friendly-childsupport-template").tmpl(a);$("#otherChildOtherWrapper .otherChild-table tbody").append(b),$("#otherChildOtherWrapper .otherChild-table").show(),Friendly.ClearForm("otherchildOther"),Friendly.EndLoading()},error:Friendly.GenericErrorMessage}),Friendly.EndLoading()}),$(".financial-part10").click(function(){!$(this).hasClass("next"),$(this).hasClass("previous")&&Friendly.SubmitFormOther("circumstanceOther","otherChildrenOther")}),$('#circumstanceOther input[name="Circumstances"]').change(function(){$("#circumstanceOther #Circumstances:checked").val()==="1"?$("#circumstanceOther .circumstance-other").show():$("#circumstanceOther .circumstance-other").hide()})})
;$(document).ready(function(){$("#printForm").click(function(){var a=$("#main-content").html();$.ajax({url:"/Output/PrintForm",type:"POST",data:{html:a},success:function(a){},error:Friendly.GenericErrorMessage})})})
;$(document).ready(function(){function a(){var a=$("#PlaintiffCustodialParent:checked").val(),b,c;a==="1"?(b=$("#PlaintiffRelationship:checked").parent().text().trim(),c=$("#DefendantRelationship:checked").parent().text().trim(),$(".nonCustodial").text(c),$(".custodial").text(b)):(b=$("#DefendantRelationship:checked").parent().text().trim(),c=$("#PlaintiffRelationship:checked").parent().text().trim(),$(".nonCustodial").text(c),$(".custodial").text(b))}function d(a){b=[],$(".copy-button ul").empty(),$(".copy-button ul").append('<li><a title="all" data-id="0" href="#">All</a></li>'),$.each($(".child-table tbody tr"),function(a,c){var d={Name:$(c).find(".child-name").text(),Gender:$(c).find(".child-gender").text(),DateOfBirth:$(c).find(".child-dob").text(),Id:$(c).find(".child-id").text().trim()};b.push(d),$(".copy-button ul").append('<li><a title="all" data-id="'+d.Id+'" href="#">'+d.Name+"</a></li>")}),c=0;var d=b[c];switch(a){case"decision":h(d);break;case"holiday":i(d)}}function e(a){f(a);var b=g(a);$.ajax({url:"/Forms/Decisions/",type:"POST",data:b,success:function(){},error:Friendly.GenericErrorMessage})}function f(a){$.each($(".extra-decision-item"),function(b,c){var d=$(c).children("#extra-decision-Id").val(),e={Id:typeof a=="undefined"?d:0,ChildId:typeof a=="undefined"?$(c).children("#extra-decision-childId").val():a,DecisionMaker:$(c).find("input[name=ExtraDecisions"+d+"]:checked").val(),Description:$(c).children("#extra-decision-description").text().trim()};if(typeof a!="undefined"){$.ajax({url:"/Forms/GetChildDecision/"+a,type:"GET",success:function(a){$.each(a.ExtraDecisions,function(a,b){b.Description===e.Description&&(e.Id=b.Id)}),$.ajax({url:"/Forms/ExtraDecisions/",type:"POST",data:e,success:function(){},error:Friendly.GenericErrorMessage})},error:Friendly.GenericErrorMessage});return}$.ajax({url:"/Forms/ExtraDecisions/",type:"POST",data:e,success:function(){},error:Friendly.GenericErrorMessage})})}function g(a){return{Education:$("#DecisionsViewModel_Education:checked").val(),HealthCare:$("#DecisionsViewModel_HealthCare:checked").val(),Religion:$("#DecisionsViewModel_Religion:checked").val(),ExtraCurricular:$("#DecisionsViewModel_ExtraCurricular:checked").val(),ChildId:typeof a=="undefined"?$("#childId").val():a}}function h(a){$.ajax({url:"/Forms/GetChildDecision/"+a.Id,type:"GET",success:function(b){$("#childName").text(a.Name),$("#childId").val(a.Id),$('#DecisionsViewModel_Education[value="'+b.Decisions.Education+'"]').attr("checked","checked"),$('#DecisionsViewModel_HealthCare[value="'+b.Decisions.HealthCare+'"]').attr("checked","checked"),$('#DecisionsViewModel_Religion[value="'+b.Decisions.Religion+'"]').attr("checked","checked"),$('#DecisionsViewModel_ExtraCurricular[value="'+b.Decisions.ExtraCurricular+'"]').attr("checked","checked"),$(".extra-decision-item").remove(),$.each(b.ExtraDecisions,function(a,b){var c=$("#friendly-extraDecisions-template").tmpl(b);$("#decisions").append(c)}),$("#decisionsWrapper").show(),$(".decision-item").addClass("active")},error:Friendly.GenericErrorMessage})}function i(a){$.ajax({url:"/Forms/GetChildHoliday/"+a.Id,type:"GET",success:function(b){Friendly.ClearForm("holiday"),$("#holidayChildName").text(a.Name),$("#holidayChildId").val(a.Id),b.Holidays.FridayHoliday&&$("#HolidayViewModel_FridayHoliday").attr("checked","checked"),b.Holidays.MondayHoliday&&$("#HolidayViewModel_MondayHoliday").attr("checked","checked"),$('#HolidayViewModel_Thanksgiving[value="'+b.Holidays.Thanksgiving+'"]').attr("checked","checked"),$("#HolidayViewModel_ThanksgivingOther").val(b.Holidays.ThanksgivingOther),$('#HolidayViewModel_Christmas[value="'+b.Holidays.Christmas+'"]').attr("checked","checked"),$("#HolidayViewModel_ChristmasTime").val(b.Holidays.ChristmasTime),$("#HolidayViewModel_ChristmasOther").val(b.Holidays.ChristmasOther),$('#HolidayViewModel_SpringBreak[value="'+b.Holidays.SpringBreak+'"]').attr("checked","checked"),$("#HolidayViewModel_SpringOther").val(b.Holidays.SpringOther),$("#HolidayViewModel_SummerBeginDays").val(b.Holidays.SummerBeginDays),$("#HolidayViewModel_SummerBeginTime").val(b.Holidays.SummerBeginTime),$("#HolidayViewModel_SummerEndDays").val(b.Holidays.SummerEndDays),$("#HolidayViewModel_SummerEndTime").val(b.Holidays.SummerEndTime),$("#HolidayViewModel_SummerDetails").val(b.Holidays.SummerDetails),$('#HolidayViewModel_FallBreak[value="'+b.Holidays.FallBreak+'"]').attr("checked","checked"),$("#HolidayViewModel_FallOther").val(b.Holidays.FallOther),$('#HolidayViewModel_MlkFather[value="'+b.Holidays.MlkFather+'"]').attr("checked","checked"),$('#HolidayViewModel_MlkMother[value="'+b.Holidays.MlkMother+'"]').attr("checked","checked"),$('#HolidayViewModel_PresidentsFather[value="'+b.Holidays.PresidentsFather+'"]').attr("checked","checked"),$('#HolidayViewModel_PresidentsMother[value="'+b.Holidays.PresidentsMother+'"]').attr("checked","checked"),$('#HolidayViewModel_MothersFather[value="'+b.Holidays.MothersFather+'"]').attr("checked","checked"),$('#HolidayViewModel_MothersMother[value="'+b.Holidays.MothersMother+'"]').attr("checked","checked"),$('#HolidayViewModel_MemorialFather[value="'+b.Holidays.MemorialFather+'"]').attr("checked","checked"),$('#HolidayViewModel_MemorialMother[value="'+b.Holidays.MemorialMother+'"]').attr("checked","checked"),$('#HolidayViewModel_FathersFather[value="'+b.Holidays.FathersFather+'"]').attr("checked","checked"),$('#HolidayViewModel_FathersMother[value="'+b.Holidays.FathersMother+'"]').attr("checked","checked"),$('#HolidayViewModel_IndependenceFather[value="'+b.Holidays.IndependenceFather+'"]').attr("checked","checked"),$('#HolidayViewModel_IndependenceMother[value="'+b.Holidays.IndependenceMother+'"]').attr("checked","checked"),$('#HolidayViewModel_LaborFather[value="'+b.Holidays.LaborFather+'"]').attr("checked","checked"),$('#HolidayViewModel_LaborMother[value="'+b.Holidays.LaborMother+'"]').attr("checked","checked"),$('#HolidayViewModel_HalloweenFather[value="'+b.Holidays.HalloweenFather+'"]').attr("checked","checked"),$('#HolidayViewModel_HalloweenMother[value="'+b.Holidays.HalloweenMother+'"]').attr("checked","checked"),$('#HolidayViewModel_ChildrensFather[value="'+b.Holidays.ChildrensFather+'"]').attr("checked","checked"),$('#HolidayViewModel_ChildrensMother[value="'+b.Holidays.ChildrensMother+'"]').attr("checked","checked"),$('#HolidayViewModel_MothersBdayFather[value="'+b.Holidays.MothersBdayFather+'"]').attr("checked","checked"),$('#HolidayViewModel_MothersBdayMother[value="'+b.Holidays.MothersBdayMother+'"]').attr("checked","checked"),$('#HolidayViewModel_FathersBdayFather[value="'+b.Holidays.FathersBdayFather+'"]').attr("checked","checked"),$('#HolidayViewModel_FathersBdayMother[value="'+b.Holidays.FathersBdayMother+'"]').attr("checked","checked"),$('#HolidayViewModel_ReligiousFather[value="'+b.Holidays.ReligiousFather+'"]').attr("checked","checked"),$('#HolidayViewModel_ReligiousMother[value="'+b.Holidays.ReligiousMother+'"]').attr("checked","checked"),$(".extra-holiday-item").remove(),$.each(b.ExtraHolidays,function(a,b){var c=$("#friendly-extraHolidays-template").tmpl(b);$("#holiday").append(c)}),$("#holidayWrapper").show(),$(".holiday-item").addClass("active")},error:Friendly.GenericErrorMessage})}function j(a,b){switch(b){case"1":$("#"+a+'[value="2"]').attr("checked","checked");break;case"2":$("#"+a+'[value="1"]').attr("checked","checked");break;case"3":$("#"+a+'[value="4"]').attr("checked","checked");break;case"4":$("#"+a+'[value="3"]').attr("checked","checked")}}function k(a){$.each($(".extra-holiday-item"),function(b,c){var d=$(c).children("#extra-holiday-Id").val(),e={Id:typeof a=="undefined"?d:0,ChildId:typeof a=="undefined"?$(c).children("#extra-holiday-childId").val():a,HolidayFather:$(c).find("input[name=HolidayFather"+d+"]:checked").val(),HolidayMother:$(c).find("input[name=HolidayMother"+d+"]:checked").val(),HolidayName:$(c).children(".extra-holiday-name").text()};if(typeof a!="undefined"){$.ajax({url:"/Forms/GetChildHoliday/"+a,type:"GET",success:function(a){$.each(a.ExtraHolidays,function(a,b){b.HolidayName===e.HolidayName&&(e.Id=b.Id)}),$.ajax({url:"/Forms/ExtraHolidays/",type:"POST",data:e,success:function(){},error:Friendly.GenericErrorMessage})},error:Friendly.GenericErrorMessage});return}$.ajax({url:"/Forms/ExtraHolidays/",type:"POST",data:e,success:function(){},error:Friendly.GenericErrorMessage})})}function l(a){k(a);var b=Friendly.GetFormInput("holiday");b.ChildId=a,b.FridayHoliday=$("#HolidayViewModel_FridayHoliday").is(":checked"),b.MondayHoliday=$("#HolidayViewModel_MondayHoliday").is(":checked"),$.ajax({url:"/Forms/Holidays/",type:"POST",data:b,success:function(){},error:Friendly.GenericErrorMessage})}$("#child-part1").click(function(){Friendly.SubmitForm("court","participants")}),$("input[name=PlanType]").change(function(){$("#PlanDate").val(""),$("#PlanType:checked").val()==="1"?$(".court-date").hide():$(".court-date").show()}),$(".child-part2").click(function(){$("#PlaintiffsName").attr("readonly","readonly"),$("#DefendantsName").attr("readonly","readonly"),$(this).hasClass("next")&&Friendly.SubmitForm("participants","children"),$(this).hasClass("previous")&&Friendly.SubmitForm("participants","court")}),$("input[name=PlaintiffRelationship]").change(function(){var b=$("#PlaintiffRelationship:checked").val();switch(b){case"1":$('#DefendantRelationship[value="2"]').attr("checked","checked");break;case"2":$('#DefendantRelationship[value="1"]').attr("checked","checked");break;case"3":$('#DefendantRelationship[value="3"]').attr("checked","checked")}a()}),$("input[name=DefendantRelationship]").change(function(){var b=$("#DefendantRelationship:checked").val();switch(b){case"1":$('#PlaintiffRelationship[value="2"]').attr("checked","checked");break;case"2":$('#PlaintiffRelationship[value="1"]').attr("checked","checked");break;case"3":$('#PlaintiffRelationship[value="3"]').attr("checked","checked")}a()}),$("input[name=PlaintiffCustodialParent]").change(function(){var b=$("#PlaintiffCustodialParent:checked").val()%2+1;$('#DefendantCustodialParent[value="'+b+'"]').attr("checked","checked"),a()}),$("input[name=DefendantCustodialParent]").change(function(){var b=$("#DefendantCustodialParent:checked").val()%2+1;$('#PlaintiffCustodialParent[value="'+b+'"]').attr("checked","checked"),a()}),$("#addChild").click(function(){Friendly.StartLoading();if(!$("#child").valid())return Friendly.EndLoading(),!1;var a=Friendly.GetFormInput("child");return $.ajax({url:"/Forms/Children/",type:"POST",data:a,success:function(a){var b=$("#friendly-child-template").tmpl(a);return $(".child-table").show(),$(".child-table tbody").append(b),Friendly.EndLoading(),Friendly.ClearForm("children"),!1},error:Friendly.GenericErrorMessage}),!1}),$(".child-part3").click(function(){return $(this).hasClass("next")&&Friendly.NextForm("privacy"),$(this).hasClass("previous")&&Friendly.NextForm("participants"),Friendly.EndLoading(),!1}),$("input[name=NeedPrivacy]").change(function(){$("#NeedPrivacy:checked").val()==="1"?$("#detailsWrapper").show():$("#detailsWrapper").hide()}),$(".child-part4").click(function(){$(this).hasClass("next")&&Friendly.SubmitForm("privacy","information"),$(this).hasClass("previous")&&Friendly.SubmitForm("privacy","children")}),$(".child-part5").click(function(){Friendly.StartLoading();if($(this).hasClass("previous"))return Friendly.SubmitForm("information","privacy"),!1;var a=Friendly.GetFormInput("information");d("decision");var b="information",c="decisions",e="#"+b;if($(e).valid())$.ajax({url:"/Forms/"+b+"/",type:"POST",data:a,success:function(){return Friendly.NextForm(c),Friendly.EndLoading(),!1},error:Friendly.GenericErrorMessage});else return Friendly.EndLoading(),!1;return!1}),$("#addDecisions").click(function(){Friendly.StartLoading();var a="extraDecisions",b={ChildId:$("#childId").val().trim(),DecisionMaker:$("#ExtraDecisionsViewModel_DecisionMaker:checked").val(),Description:$("#ExtraDecisionsViewModel_Description").val()};if($("#"+a).valid())$.ajax({url:"/Forms/"+a+"/",type:"POST",data:b,success:function(a){var b=$("#friendly-extraDecisions-template").tmpl(a);return $("#decisions").append(b),$("input[id=ExtraDecisionsViewModel_DecisionMaker]").removeAttr("checked"),$("#ExtraDecisionsViewModel_Description").val(""),Friendly.EndLoading(),!1},error:Friendly.GenericErrorMessage});else return Friendly.EndLoading(),!1;return!1});var b=[],c;$(".decision-item").click(function(){d("decision"),Friendly.NextForm("decision")}),$(".dropdown-toggle").dropdown(),$("#copy-decisions li a").on("click",function(){if(!$("#decisions").valid())return!1;var a=$(this).attr("data-id");if(a==="0")for(var c=0;c<b.length;c++){var d=b[c];e(d.Id)}}),$(".child-part6").click(function(){if(!$("#decisions").valid())return!1;f();var a=g();return $(this).hasClass("next")?c++:c--,$(this).hasClass("next")&&c===b.length?(Friendly.SubmitForm("decisions","responsibility",a),!1):$(this).hasClass("previous")&&c<0?(Friendly.SubmitForm("decisions","information",a),!1):($.ajax({url:"/Forms/Decisions/",type:"POST",data:a,success:function(){$("input[id=DecisionsViewModel_Education]").removeAttr("checked"),$("input[id=DecisionsViewModel_HealthCare]").removeAttr("checked"),$("input[id=DecisionsViewModel_Religion]").removeAttr("checked"),$("input[id=DecisionsViewModel_ExtraCurricular]").removeAttr("checked");var a=b[c];h(a)},error:Friendly.GenericErrorMessage}),!1)}),$("input[name=TransportationCosts]").change(function(){var a=$("#TransportationCosts:checked").val();$(".responsibility-percentage").hide(),$(".responsibility-cost").hide(),$(".responsibility-percentage input").val("0"),$(".responsibility-cost input").val("");switch(a){case"3":$(".responsibility-percentage").show(),$(".responsibility-percentage input").val("");break;case"4":$(".responsibility-cost").show()}}),$(".responsibility-percentage input").focusout(function(){var a=$(this).val();$(this).attr("id")==="FatherPercentage"?$("#MotherPercentage").val(parseInt(100-a)):$("#FatherPercentage").val(parseInt(100-a))}),$(".child-part7").click(function(){var a={BeginningVisitation:$("#BeginningVisitation:checked").val(),EndVisitation:$("#EndVisitation:checked").val(),TransportationCosts:$("#TransportationCosts:checked").val(),FatherPercentage:0,MotherPercentage:0,FatherCost:"",MotherCost:""};a.TransportationCosts==="3"&&(a.FatherPercentage=$("#FatherPercentage").val(),a.MotherPercentage=$("#MotherPercentage").val()),a.TransportationCosts==="4"&&(a.FatherCost=$("#FatherCost").val(),a.MotherCost=$("#MotherCost").val()),$(this).hasClass("next")?Friendly.SubmitForm("responsibility","communication",a):$.ajax({url:"/Forms/Responsibility/",type:"POST",data:a,success:function(){$(".wrapper").hide(),$(".affix li").removeClass("active"),c=b.length-1;var a=b[c];h(a)},error:Friendly.GenericErrorMessage})}),$("#Other").change(function(){$(this).is(":checked")?$(".communicate-other").show():$(".communicate-other").hide()}),$("input[name=Limitations]").change(function(){var a=$("#Limitations:checked").val();a=="1"?$(".communicate-method").show():$(".communicate-method").hide()}),$(".child-part8").click(function(){$(this).hasClass("next")?Friendly.SubmitForm("communication","schedule"):Friendly.SubmitForm("communication","responsibility")}),$("input[name=DetermineBeginDate]").change(function(){var a=$("#DetermineBeginDate:checked").val();a==="1"?$(".schedule-date").hide():$(".schedule-date").show()}),$("input[name=Weekdays]").change(function(){var a=$("#Weekdays:checked").val();a==="1"?$(".schedule-weekday").show():$(".schedule-weekday").hide()}),$("input[name=FatherWeekend]").change(function(){var a=$("#FatherWeekend:checked").val();switch(a){case"1":$('#MotherWeekend[value="1"]').attr("checked","checked");break;case"2":$('#MotherWeekend[value="4"]').attr("checked","checked");break;case"3":$('#MotherWeekend[value="4"]').attr("checked","checked");break;case"4":$('#MotherWeekend[value="3"]').attr("checked","checked");break;case"5":$('#MotherWeekend[value="5"]').attr("checked","checked")}}),$("input[name=MotherWeekend]").change(function(){var a=$("#MotherWeekend:checked").val();switch(a){case"1":$('#FatherWeekend[value="1"]').attr("checked","checked");break;case"2":$('#FatherWeekend[value="4"]').attr("checked","checked");break;case"3":$('#FatherWeekend[value="4"]').attr("checked","checked");break;case"4":$('#FatherWeekend[value="3"]').attr("checked","checked");break;case"5":$('#FatherWeekend[value="5"]').attr("checked","checked")}}),$(".child-part9").click(function(){var a=Friendly.GetFormInput("schedule");if($(this).hasClass("previous"))return Friendly.SubmitForm("schedule","communication",a),!1;var b="schedule",c="holiday",e="#"+b;if($(e).valid())$.ajax({url:"/Forms/"+b+"/",type:"POST",data:a,success:function(){return d("holiday"),Friendly.NextForm(c),Friendly.EndLoading(),!1},error:Friendly.GenericErrorMessage});else return Friendly.EndLoading(),!1;return!1}),$("#addHolidays").click(function(){Friendly.StartLoading();var a="extraHolidays",b={ChildId:$("#holidayChildId").val(),HolidayFather:$("#ExtraHolidayViewModel_HolidayFather:checked").val(),HolidayMother:$("#ExtraHolidayViewModel_HolidayMother:checked").val(),HolidayName:$("#ExtraHolidayViewModel_HolidayName").val()};if($("#"+a).valid())$.ajax({url:"/Forms/"+a+"/",type:"POST",data:b,success:function(a){var b=$("#friendly-extraHolidays-template").tmpl(a);return $("#holiday").append(b),$("input[id=ExtraHolidayViewModel_HolidayFather]").removeAttr("checked"),$("input[id=ExtraHolidayViewModel_HolidayMother]").removeAttr("checked"),$("#ExtraHolidayViewModel_HolidayName").val(""),Friendly.EndLoading(),!1},error:Friendly.GenericErrorMessage});else return Friendly.EndLoading(),!1;return!1}),$(".father-all input[type=radio]").change(function(){var a=$(this).attr("name"),b=$('input[name="'+a+'"]:checked').val();$.each($(".holiday-parent input[value="+b+"]"),function(a,c){var d=$(c).attr("name");if(typeof d=="undefined")return;d.lastIndexOf("Father")>=0&&d.lastIndexOf("Father")>d.lastIndexOf("Mother")?$(this).attr("checked","checked"):(d=d.replace(".","_"),j(d,b))})}),$(".mother-all input[type=radio]").change(function(){var a=$(this).attr("name"),b=$('input[name="'+a+'"]:checked').val();$.each($(".holiday-parent input[value="+b+"]"),function(a,c){var d=$(c).attr("name");if(typeof d=="undefined")return;d.lastIndexOf("Mother")>=0&&d.lastIndexOf("Mother")>d.lastIndexOf("Father")?$(this).attr("checked","checked"):(d=d.replace(".","_"),j(d,b))})}),$(".holiday-parent input[type=radio]").on("change",function(){var a=$(this).attr("name"),b=$('input[name="'+a+'"]:checked').val(),c="";return a.lastIndexOf("Father")>=0&&a.lastIndexOf("Father")>a.lastIndexOf("Mother")?(c=a.substring(0,a.lastIndexOf("Father"))+"Mother",c=c.replace(".","_")):a.lastIndexOf("Mother")>=0&&a.lastIndexOf("Mother")>a.lastIndexOf("Father")&&(c=a.substring(0,a.lastIndexOf("Mother"))+"Father",c=c.replace(".","_")),j(c,b),!1}),$(".child-part10").click(function(){if($("#holiday").valid()){k();var a=Friendly.GetFormInput("holiday");return a.ChildId=$("#holidayChildId").val(),a.FridayHoliday=$("#HolidayViewModel_FridayHoliday").is(":checked"),a.MondayHoliday=$("#HolidayViewModel_MondayHoliday").is(":checked"),$(this).hasClass("next")?c++:c--,$(this).hasClass("next")&&c===b.length?!1:$(this).hasClass("previous")&&c<0?(Friendly.SubmitForm("holiday","schedule",a),!1):($.ajax({url:"/Forms/Holidays/",type:"POST",data:a,success:function(){$("#holiday")[0].reset();var a=b[c];i(a)},error:Friendly.GenericErrorMessage}),!1)}}),$('input[name="HolidayViewModel.Thanksgiving"]').change(function(){var a=$("#HolidayViewModel_Thanksgiving:checked").val();a==="3"?$(".thanksgiving-other").show():$(".thanksgiving-other").hide()}),$('input[name="HolidayViewModel.SpringBreak"]').change(function(){var a=$("#HolidayViewModel_SpringBreak:checked").val();a==="2"?$(".spring-other").show():$(".spring-other").hide()}),$('input[name="HolidayViewModel.FallBreak"]').change(function(){var a=$("#HolidayViewModel_FallBreak:checked").val();a==="2"?$(".fall-other").show():$(".fall-other").hide()}),$('input[name="HolidayViewModel.Christmas"]').change(function(){var a=$("#HolidayViewModel_Christmas:checked").val();$(".christmas-items").hide(),$(".christmas-other").hide();switch(a){case"2":$(".christmas-items").show();break;case"3":$(".christmas-items").show();break;case"4":$(".christmas-items").show();break;case"5":$(".christmas-other").show()}}),$(".holiday-item").click(function(){Friendly.NextForm("holiday"),d("holiday")}),$("#copy-holidays li a").on("click",function(){if(!$("#holiday").valid())return;var a=$(this).attr("data-id");if(a==="0")for(var c=0;c<b.length;c++){var d=b[c];l(d.Id)}else l(a)})})
