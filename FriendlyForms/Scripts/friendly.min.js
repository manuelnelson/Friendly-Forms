...
;FormsApp.filter("dollarAmount",function(){return function(a){var b=parseInt(a);return b<0?"-$"+Math.abs(b):"$"+Math.abs(b)}})
...
;var ParentingCtrl=["$scope","$routeParams","$rootScope","parentingService","menuService","genericService","headerService","$timeout",function(a,b,c,d,e,f,g,h){a.showPrintButton=!1,a.isLoaded=!1,d.parentings.get({UserId:b.userId},function(b){a.parenting=b,a.isLoaded=!0,h(function(){var b=$("#main-content").html();b=b.replace(/<form.*>/,""),b=b.replace(/<input.*>/g,""),b=b.replace(/<footer[^>]*?>([\s\S]*)<\/footer>/,""),$(".html").val(b),$(".name").val("Parenting"),g.showOutputHeader(),a.showPrintButton=!0},2500)}),a.submit=function(a){},c.currentScope=a,g.hide()}]
...
;var ScheduleACtrl=["$scope","$routeParams","$rootScope","scheduleAService","menuService","genericService","headerService","$timeout",function(a,b,c,d,e,f,g,h){a.showPrintButton=!1,a.isLoaded=!1,d.scheduleAs.get({UserId:b.userId},function(b){b.Income.OtherDetails||(b.Income.OtherDetails="There is no reason for having other income."),b.OtherIncome.OtherDetails||(b.Income.OtherDetails="There is no reason for having other income."),a.scheduleA=b,a.isLoaded=!0,h(function(){var b=$("#main-content").html();b=b.replace(/<form.*>/,""),b=b.replace(/<input.*>/g,""),b=b.replace(/<footer[^>]*?>([\s\S]*)<\/footer>/,""),$(".html").val(b),$(".name").val("ScheduleA"),g.showOutputHeader(),a.showPrintButton=!0},2500)}),a.submit=function(a){},c.currentScope=a,g.hide()}]
...
;var ScheduleBCtrl=["$scope","$routeParams","$rootScope","scheduleBService","menuService","genericService","headerService","$timeout",function(a,b,c,d,e,f,g,h){a.showPrintButton=!1,a.isLoaded=!1,d.scheduleBs.get({UserId:b.userId},function(b){a.scheduleB=b,a.isLoaded=!0,h(function(){var b=$("#main-content").html();b=b.replace(/<form.*>/,""),b=b.replace(/<input.*>/g,""),b=b.replace(/<footer[^>]*?>([\s\S]*)<\/footer>/,""),$(".html").val(b),$(".name").val("ScheduleB"),g.showOutputHeader(),a.showPrintButton=!0},2500)}),a.submit=function(a){},c.currentScope=a,g.hide()}]
...
;var ScheduleDCtrl=["$scope","$routeParams","$rootScope","scheduleDService","menuService","genericService","headerService","$timeout",function(a,b,c,d,e,f,g,h){a.showPrintButton=!1,a.isLoaded=!1,d.scheduleDs.get({UserId:b.userId},function(b){a.scheduleD=b,a.isLoaded=!0,h(function(){var b=$("#main-content").html();b=b.replace(/<form.*>/,""),b=b.replace(/<input.*>/g,""),b=b.replace(/<footer[^>]*?>([\s\S]*)<\/footer>/,""),$(".html").val(b),$(".name").val("ScheduleD"),g.showOutputHeader(),a.showPrintButton=!0},2500)}),a.submit=function(a){},c.currentScope=a,g.hide()}]
...
;var ScheduleECtrl=["$scope","$routeParams","$rootScope","scheduleEService","menuService","genericService","headerService","$timeout",function(a,b,c,d,e,f,g,h){a.showPrintButton=!1,a.isLoaded=!1,d.scheduleEs.get({UserId:b.userId},function(b){a.scheduleE=b,a.isLoaded=!0,h(function(){var b=$("#main-content").html();b=b.replace(/<form.*>/,""),b=b.replace(/<input.*>/g,""),b=b.replace(/<footer[^>]*?>([\s\S]*)<\/footer>/,""),$(".html").val(b),$(".name").val("ScheduleE"),g.showOutputHeader(),a.showPrintButton=!0},2500)}),a.submit=function(a){},c.currentScope=a,g.hide()}]
...
;var ChildSupportOutputCtrl=["$scope","$routeParams","$rootScope","childSupportOutputService","menuService","headerService","$timeout",function(a,b,c,d,e,f,g){a.showPrintButton=!1,a.isLoaded=!1,d.childSupports.get({UserId:b.userId},function(b){a.childSupport=b,a.isLoaded=!0,g(function(){var b=$("#main-content").html();b=b.replace(/<form.*>/,""),b=b.replace(/<input.*>/g,""),b=b.replace(/<footer[^>]*?>([\s\S]*)<\/footer>/,""),$(".html").val(b),$(".name").val("ChildSupportWorksheet"),f.showOutputHeader(),a.showPrintButton=!0},2500)}),a.submit=function(a){},c.currentScope=a,f.hide()}]
...
;var CSACtrl=function(a,b,c,d,e,f,g,h){a.showPrintButton=!1,a.isLoaded=!1,d.csas.get({UserId:b.userId},function(b){a.csa=b,a.isLoaded=!0,h(function(){var b=$("#main-content").html();b=b.replace(/<form[^>]*?>([\s\S]*)<\/form>/,""),b=b.replace(/<footer[^>]*?>([\s\S]*)<\/footer>/,""),$(".html").val(b),$(".name").val("ChildSupportAddendum"),g.showOutputHeader(),a.showPrintButton=!0},2500)}),a.submit=function(a){},c.currentScope=a,g.hide()};CSACtrl.$inject=["$scope","$routeParams","$rootScope","csaService","menuService","genericService","headerService","$timeout"]
