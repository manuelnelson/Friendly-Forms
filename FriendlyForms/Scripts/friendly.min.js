...
;var DecisionCtrl=function(a,b,c,d,e,f,g){function h(c){var e=angular.copy(a.extraDecisions);d.extraDecisions.get({ChildId:c},function(f){_.each(f.ExtraDecisions,function(a){var b=_.find(e,function(b){return b.Description==a.Description});b&&(b.Id=a.Id,b.ChildId=a.ChildId,d.extraDecisions.update(null,b,function(){}),e=_.reject(e,function(b){return b.Description==a.Description}))}),_.each(e,function(a){a.ChildId=c,d.extraDecisions.save(null,a,function(){})}),d.decisions.get({ChildId:c},function(e){var f=angular.copy(a.decision);f.UserId=b.userId,f.ChildId=c,typeof e.Id!="undefined"?(f.Id=e.Id,d.decisions.update(null,f,function(){a.showMessage=!0})):d.decisions.save(null,f,function(){a.showMessage=!0})})})}a.path=c.path(),a.showErrors=!1,a.showMessage=!1,a.showExtraErrors=!1,d.children.get({UserId:b.userId},function(c){a.children=c.Children,a.childNdx=_.indexOf(_.pluck(a.children,"Id"),parseInt(b.childId)),a.childName=a.children[a.childNdx].Name,a.menuPath="/Parenting/Decision/user/"+b.userId+"/child/"+a.children[0].Id,e.isActive(a.menuPath)||e.setActive(a.menuPath)}),a.getChildDecision=function(b){a.decision=d.decisions.get({ChildId:b},function(){if(typeof a.decision.Id=="undefined"||a.decision.Id==0)a.decision=$.jStorage.get(a.path)}),d.extraDecisions.get({ChildId:b},function(b){b.ExtraDecisions.length===0&&(a.extraDecisions=[]),a.extraDecisions=b.ExtraDecisions})},a.addExtraDecision=function(){if(a.addDecisionForm.$invalid){a.showExtraErrors=!0;return}a.showExtraErrors=!1,a.extraDecision.ChildId=a.children[a.childNdx].Id,d.extraDecisions.save(null,a.extraDecision,function(b){a.extraDecisions.push(b),a.extraDecision.DecisionMaker=-1,a.extraDecision.Description="",a.addDecisionForm.$setPristine()})},a.submit=function(c,g){if(a.decisionForm.$invalid){e.setSubMenuIconClass(a.menuPath,"icon-pencil icon-red");var h=f.getFormInput("#decisionForm");$.jStorage.set(a.path,h),a.showErrors=!0;return}$.jStorage.deleteKey(a.path),a.decision.UserId=b.userId,a.decision.ChildId=a.children[a.childNdx].Id,typeof a.decision.Id=="undefined"||a.decision.Id==0?d.decisions.save(null,a.decision,function(){}):d.decisions.update({Id:a.decision.Id},a.decision,function(){}),e.setSubMenuIconClass(a.menuPath,"icon-ok icon-green");if(a.extraDecisions.length>0){var i=0;_.each(a.extraDecisions,function(b){d.extraDecisions.update(null,b,function(){i++,a.extraDecisions.length===i&&g&&g()})})}else g&&g()},a.previousChild=function(){a.submit(!1,function(){a.childNdx=_.indexOf(_.pluck(a.children,"Id"),parseInt(b.childId));if(a.childNdx===0){e.previousMenu();return}a.childNdx=a.childNdx-1;var d=a.children[a.childNdx].Id;c.path("/Parenting/Decision/user/"+b.userId+"/child/"+d)})},a.nextChild=function(){a.submit(!1,function(){a.childNdx=_.indexOf(_.pluck(a.children,"Id"),parseInt(b.childId));if(a.childNdx===a.children.length-1){e.nextMenu();return}a.childNdx=a.childNdx+1;var d=a.children[a.childNdx].Id;e.setSubMenuIconClass(a.path,"icon-ok icon-green"),c.path("/Parenting/Decision/user/"+b.userId+"/child/"+d)})},a.copyChild=function(c){a.submit(!1,function(){c===0?_.each(a.children,function(a){a.childId!=b.childId&&h(a.Id)}):h(c)})},a.getChildDecision(b.childId),f.refreshPage(function(){g.currentScope=a})};DecisionCtrl.$inject=["$scope","$routeParams","$location","decisionService","menuService","genericService","$rootScope"]
...
;var OtherChildCtrl=["$scope","$routeParams","$location","otherChildService","menuService","genericService","$rootScope",function(a,b,c,d,e,f,g){a.continuePressed=!1,a.path=c.path(),a.showErrors=!1,d.otherChildren.get({UserId:b.userId,IsOtherParent:b.isOtherParent},function(c){typeof c.Id=="undefined"||c.Id==0?(a.otherChildren=$.jStorage.get(a.path),a.otherChildren&&(a.showErrors=!0)):a.otherChildren=c,typeof a.otherChildren!="undefined"&&a.otherChildren!==null&&a.otherChildren.Id>0?d.otherChild.get({OtherChildrenId:b.userId},function(b){b.OtherChildren.length==0?a.children=[]:a.children=b.OtherChildren}):a.children=[]}),a.showMessage=!1,a.checkToShowMessage=function(){(a.otherChildren.LegallyResponsible!=1||a.otherChildren.AtHome!=1||a.otherChildren.Support!=1||a.otherChildren.Preexisting!=2||a.otherChildren.InCourt!=2)&&a.otherChildrenForm.LegallyResponsible.$dirty&&a.otherChildrenForm.AtHome.$dirty&&a.otherChildrenForm.Support.$dirty&&a.otherChildrenForm.Preexisting.$dirty&&a.otherChildrenForm.InCourt.$dirty&&(a.showMessage=!0)},a.submit=function(c){if(a.otherChildrenForm.$invalid){e.setSubMenuIconClass(a.path,"icon-pencil icon-red");var g=f.getFormInput("#otherChildrenForm");$.jStorage.set(a.path,g),c||e.nextMenu();return}$.jStorage.deleteKey(a.path),a.otherChildren.UserId=b.userId,a.otherChildren.IsOtherParent=b.isOtherParent,typeof a.otherChildren.Id=="undefined"||a.otherChildren.Id==0?d.otherChildren.save(null,a.otherChildren,function(){e.setSubMenuIconClass(a.path,"icon-ok icon-green"),c||e.nextMenu()}):d.otherChildren.update(null,a.otherChildren,function(){e.setSubMenuIconClass(a.path,"icon-ok icon-green"),c||e.nextMenu()})},a.addOtherChild=function(){a.otherChild.UserId=b.userId,a.otherChild.OtherChildrenId=a.otherChildren.Id,d.otherChild.save(null,a.otherChild,function(b){e.setSubMenuIconClass(a.path,"icon-ok icon-green"),a.children.push(b.OtherChild),a.otherChildForm.$setPristine(),a.otherChild=""})},a.deleteOtherChild=function(b){d.otherChild.delete({Id:b.Id},function(){a.children=_.reject(a.children,function(a){return a.Id==b.Id})})},f.refreshPage(function(){g.currentScope=a})}]
...
;FormsApp.factory("formCompleteService",["$resource","menuService",function(a,b){var c={formCompletes:a("/api/output/formComplete/",{},{get:{method:"GET",params:{format:"json"}},update:{method:"PUT",params:{format:"json"}}}),child:a("/api/child/",{},{update:{method:"PUT"},deleteAll:{method:"DELETE"}}),getOutputPaths:function(a,b){switch(a){case"ParentingPlan":return["/Output/Parenting/User/"+b];case"MediationAgreement":return["/Output/DomesticMediation/User/"+b];case"FinancialForm":return["/Output/ScheduleA/User/"+b,"/Output/ScheduleB/User/"+b,"/Output/ScheduleD/User/"+b,"/Output/ScheduleE/User/"+b,"/Output/CSA/User/"+b,"/Output/ChildSupport/User/"+b];default:return[]}}};return c}])
;var FormCompleteCtrl=function(a,b,c,d,e,f,g,h){function i(){d.formCompletes.get({FormName:b.formName,UserId:b.userId},function(c){if(c.IncompleteForms.length===0){a.NoErrors=!0;var f=d.getOutputPaths(b.formName,b.userId);for(var g=0;g<f.length;g++)e.enableMenu(f[g])}else a.IncompleteForms=c.IncompleteForms,a.NoErrors=!1;a.CheckingFormProgress=!1})}a.storageKey=c.path(),a.formName=b.formName,a.CheckingFormProgress=!0,a.NoErrors=!0,i(),a.isStarter=b.formName=="Starter",a.submit=function(a){if(a)return;b.formName==="Starter"?e.getMenu().then(function(){c.path("/Domestic/House/user/"+b.userId)}):c.path(d.getOutputPaths(b.formName,b.userId)[0])},h.currentScope=a,g.setTitle("Form Completed")};FormCompleteCtrl.$inject=["$scope","$routeParams","$location","formCompleteService","menuService","genericService","headerService","$rootScope"]
...
;var ParentingCtrl=["$scope","$routeParams","$rootScope","parentingService","menuService","genericService","headerService","$timeout",function(a,b,c,d,e,f,g,h){a.showPrintButton=!1,d.parentings.get({UserId:b.userId},function(b){a.parenting=b,h(function(){var b=$("#main-content").html();b=b.replace(/<form.*>/,""),b=b.replace(/<input.*>/g,""),b=b.replace(/<footer[^>]*?>([\s\S]*)<\/footer>/,""),$(".html").val(b),$(".name").val("Parenting"),g.showOutputHeader(),a.showPrintButton=!0},2500)}),a.submit=function(a){},c.currentScope=a,g.hide()}]
...
;var ScheduleACtrl=["$scope","$routeParams","$rootScope","scheduleAService","menuService","genericService","headerService","$timeout",function(a,b,c,d,e,f,g,h){a.showPrintButton=!1,d.scheduleAs.get({UserId:b.userId},function(b){a.scheduleA=b,h(function(){var b=$("#main-content").html();b=b.replace(/<form.*>/,""),b=b.replace(/<input.*>/g,""),b=b.replace(/<footer[^>]*?>([\s\S]*)<\/footer>/,""),$(".html").val(b),$(".name").val("ScheduleA"),g.showOutputHeader(),a.showPrintButton=!0},2500)}),a.submit=function(a){},c.currentScope=a,g.hide()}]
...
;var ScheduleBCtrl=["$scope","$routeParams","$rootScope","scheduleBService","menuService","genericService","headerService","$timeout",function(a,b,c,d,e,f,g,h){a.showPrintButton=!1,d.scheduleBs.get({UserId:b.userId},function(b){a.scheduleB=b,h(function(){var b=$("#main-content").html();b=b.replace(/<form.*>/,""),b=b.replace(/<input.*>/g,""),b=b.replace(/<footer[^>]*?>([\s\S]*)<\/footer>/,""),$(".html").val(b),$(".name").val("ScheduleB"),g.showOutputHeader(),a.showPrintButton=!0},2500)}),a.submit=function(a){},c.currentScope=a,g.hide()}]
...
;var ScheduleDCtrl=["$scope","$routeParams","$rootScope","scheduleDService","menuService","genericService","headerService","$timeout",function(a,b,c,d,e,f,g,h){a.showPrintButton=!1,d.scheduleDs.get({UserId:b.userId},function(b){a.scheduleD=b,h(function(){var b=$("#main-content").html();b=b.replace(/<form.*>/,""),b=b.replace(/<input.*>/g,""),b=b.replace(/<footer[^>]*?>([\s\S]*)<\/footer>/,""),$(".html").val(b),$(".name").val("ScheduleD"),g.showOutputHeader(),a.showPrintButton=!0},2500)}),a.submit=function(a){},c.currentScope=a,g.hide()}]
...
;var ScheduleECtrl=["$scope","$routeParams","$rootScope","scheduleEService","menuService","genericService","headerService","$timeout",function(a,b,c,d,e,f,g,h){a.showPrintButton=!1,d.scheduleEs.get({UserId:b.userId},function(b){a.scheduleE=b,h(function(){var b=$("#main-content").html();b=b.replace(/<form.*>/,""),b=b.replace(/<input.*>/g,""),b=b.replace(/<footer[^>]*?>([\s\S]*)<\/footer>/,""),$(".html").val(b),$(".name").val("ScheduleE"),g.showOutputHeader(),a.showPrintButton=!0},2500)}),a.submit=function(a){},c.currentScope=a,g.hide()}]
...
;var ChildSupportOutputCtrl=["$scope","$routeParams","$rootScope","childSupportOutputService","menuService","headerService","$timeout",function(a,b,c,d,e,f,g){a.showPrintButton=!1,d.childSupports.get({UserId:b.userId},function(b){a.childSupport=b,g(function(){var b=$("#main-content").html();b=b.replace(/<form.*>/,""),b=b.replace(/<input.*>/g,""),b=b.replace(/<footer[^>]*?>([\s\S]*)<\/footer>/,""),$(".html").val(b),$(".name").val("ChildSupport"),f.showOutputHeader(),a.showPrintButton=!0},2500)}),a.submit=function(a){},c.currentScope=a,f.hide()}]
...
;var CSACtrl=function(a,b,c,d,e,f,g,h){a.showPrintButton=!1,d.csas.get({UserId:b.userId},function(b){a.csa=b,h(function(){var b=$("#main-content").html();b=b.replace(/<form.*>/,""),b=b.replace(/<footer[^>]*?>([\s\S]*)<\/footer>/,""),$(".html").val(b),$(".name").val("ChildSupportAddendum"),g.showOutputHeader(),a.showPrintButton=!0},2500)}),a.submit=function(a){},c.currentScope=a,g.hide()};CSACtrl.$inject=["$scope","$routeParams","$rootScope","csaService","menuService","genericService","headerService","$timeout"]
...
;var PaymentCtrl=["$scope","$routeParams","$location","paymentService","menuService","headerService","userService",function(a,b,c,d,e,f,g){f.setTitle("Payment"),a.submit=function(){if(a.paymentForm.$invalid)return;var d=b.userId;g.getCurrentUserSession().then(function(a){g.roles.save(null,{UserName:a.UserName,Roles:["FirmAdmin","Lawyer"]},function(){c.path("/Administration/ClientCases/"+d)})})}}]
...
;FormsApp.factory("clientCasesService",["$resource",function(a){var b={clientCases:a("/api/clientCases/:userId",{userId:"@userId"},{get:{method:"GET",params:{format:"json"}},update:{method:"PUT",params:{format:"json"}}})};return b}])
;var ClientCasesCtrl=["$scope","$routeParams","$location","clientCasesService","menuService","genericService","$rootScope",function(a,b,c,d,e,f,g){a.path=c.path(),a.clientCases=d.clientCases.get({UserId:b.userId},function(){if(typeof a.clientCases.Id=="undefined"||a.clientCases.Id==0)a.clientCases=$.jStorage.get(a.path)}),a.submit=function(c){if(a.clientCasesForm.$invalid){e.setSubMenuIconClass(a.path,"icon-pencil icon-red");var g=f.getFormInput("#clientCasesForm");$.jStorage.set(a.path,g),c||e.nextMenu();return}$.jStorage.deleteKey(a.storageKey),a.clientCases.UserId=b.userId,typeof a.clientCases.Id=="undefined"||a.clientCases.Id==0?d.clientCases.save(null,a.clientCases,function(){e.setSubMenuIconClass(a.path,"icon-ok icon-green"),c||e.nextMenu()}):d.clientCases.update({Id:a.clientCases.Id},a.clientCases,function(){e.setSubMenuIconClass(a.path,"icon-ok icon-green"),c||e.nextMenu()})},f.refreshPage()}]
...
;var AttorneyPageCtrl=["$scope","$routeParams","$location","attorneyPageService","userService","menuService","headerService","clientService",function(a,b,c,d,e,f,g,h){a.clients=[],a.userId=b.userId,h.clients.getList({UserId:b.userId},function(b){var c=_.pluck(b,"ClientUserId");c&&c.length>0&&e.userAuths.getList({Ids:c},function(c){var d=_.map(b,function(a){var b=_.find(c,function(b){return b.Id===a.ClientUserId});return{UserId:a.UserId,ClientUserId:a.ClientUserId,CaseNumber:a.CaseNumber,Name:b.DisplayName,Date:b.Date}});a.clients=d})}),a.openClient=function(a){c.path("/Client/"+a.ClientUserId)},a.archiveClient=function(a){},g.setTitle("Attorney Page")}]
;FormsApp.factory("createClientService",["$resource",function(a){var b={};return b}])
;var CreateClientCtrl=["$scope","$routeParams","$location","clientService","courtService","headerService","userService",function(a,b,c,d,e,f,g){a.submit=function(){if(a.createClientForm.$invalid)return;var f=a.user.Email;f.indexOf(!1)&&(f=a.user.Email+"@ourlawfirm.com"),g.register.save(null,{DisplayName:a.user.DisplayName,Email:f,Password:a.user.Password,ConfirmPassword:a.user.ConfirmPassword,PrimaryEmail:a.user.PrimaryEmail},function(f){var g={UserId:f.UserId,County:0,CaseNumber:a.court.CaseNumber,AuthorOfPlan:1,PlanType:1},h={UserId:b.userId,ClientUserId:f.UserId};d.clients.save(null,h,function(){e.courts.save(null,g,function(){c.path("/Attorney/Client/"+h.ClientUserId)})})})},f.setTitle("Create A Client")}]
;FormsApp.factory("clientService",["$resource",function(a){var b={clients:a("/api/AttorneyClients/clients",{},{get:{method:"GET",params:{format:"json"}},getList:{method:"GET",isArray:!0,params:{format:"json"}},update:{method:"PUT",params:{format:"json"}}}),attorneys:a("/api/AttorneyClients/attorneys",{},{get:{method:"GET",params:{format:"json"}},getList:{method:"GET",isArray:!0,params:{format:"json"}},update:{method:"PUT",params:{format:"json"}}})};return b}])
;var ClientCtrl=["$scope","$routeParams","$location","clientService","menuService","headerService","userService","courtService","$rootScope",function(a,b,c,d,e,f,g,h,i){a.userAuth=g.getUserAuth(b.userId),a.user=g.getUserData(b.userId),a.court=h.courts.get({UserId:b.userId},function(){}),d.attorneys.getList({ClientUserId:b.userId},function(b){a.authorizedPeople=b,typeof b!="undefined"&&b.length>0&&g.getUserData(b[0].UserId).then(function(b){g.getLawFirmUsers(b.LawFirmId).then(function(b){a.lawFirmUsers=b})})}),a.submit=function(b){if(a.clientForm.$invalid)return},a.notify=function(a,b){b.NotificationsEnabled=a.target.checked,d.clients.update(null,b,function(){})},i.currentScope=a,f.setTitle("Client Profile")}]
...
;var LoginMenuCtrl=function(a,b,c,d){a.$watch(function(){return d.authUser},function(){a.user=d.authUser},!0),d.refresh()};LoginMenuCtrl.$inject=["$scope","$routeParams","$location","loginMenuService"]
...
;var UnauthorizedCtrl=function(a,b,c,d,e,f){f.setTitle("Unauthorized")};UnauthorizedCtrl.$inject=["$scope","$routeParams","$location","unauthorizedService","menuService","headerService"]
