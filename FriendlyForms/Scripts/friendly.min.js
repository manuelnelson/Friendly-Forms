...
;var DecisionCtrl=function(a,b,c,d,e,f,g){function h(c){var e=angular.copy(a.extraDecisions);d.extraDecisions.get({ChildId:c},function(f){_.each(f.ExtraDecisions,function(a){var b=_.find(e,function(b){return b.Description==a.Description});b&&(b.Id=a.Id,b.ChildId=a.ChildId,d.extraDecisions.update(null,b,function(){}),e=_.reject(e,function(b){return b.Description==a.Description}))}),_.each(e,function(a){a.ChildId=c,d.extraDecisions.save(null,a,function(){})}),d.decisions.get({ChildId:c},function(e){var f=angular.copy(a.decision);f.UserId=b.userId,f.ChildId=c,typeof e.Id!="undefined"?(f.Id=e.Id,d.decisions.update(null,f,function(){a.showMessage=!0})):d.decisions.save(null,f,function(){a.showMessage=!0})})})}a.path=c.path(),a.showErrors=!1,a.showMessage=!1,g.currentScope=a,d.children.get({UserId:b.userId},function(c){a.children=c.Children,a.childNdx=_.indexOf(_.pluck(a.children,"Id"),parseInt(b.childId)),a.childName=a.children[a.childNdx].Name,a.menuPath="/Parenting/Decision/user/"+b.userId+"/child/"+a.children[0].Id,e.isActive(a.menuPath)||e.setActive(a.menuPath)}),a.getChildDecision=function(b){a.decision=d.decisions.get({ChildId:b},function(){if(typeof a.decision.Id=="undefined"||a.decision.Id==0)a.decision=$.jStorage.get(a.path)}),d.extraDecisions.get({ChildId:b},function(b){b.ExtraDecisions.length===0&&(a.extraDecisions=[]),a.extraDecisions=b.ExtraDecisions})},a.addExtraDecision=function(){if(a.addDecisionForm.$invalid)return;a.extraDecision.ChildId=b.childId,d.extraDecisions.save(null,a.extraDecision,function(b){a.extraDecisions.push(b),a.extraDecision.DecisionMaker=-1,a.extraDecision.Description=""})},a.submit=function(c,g){if(a.decisionForm.$invalid){e.setSubMenuIconClass(a.menuPath,"icon-pencil icon-red");var h=f.getFormInput("#decisionForm");$.jStorage.set(a.path,h),a.showErrors=!0;return}$.jStorage.deleteKey(a.path),a.decision.UserId=b.userId,a.decision.ChildId=b.childId,typeof a.decision.Id=="undefined"||a.decision.Id==0?d.decisions.save(null,a.decision,function(){}):d.decisions.update({Id:a.decision.Id},a.decision,function(){}),e.setSubMenuIconClass(a.menuPath,"icon-ok icon-green");if(a.extraDecisions.length>0){var i=0;_.each(a.extraDecisions,function(b){d.extraDecisions.update(null,b,function(){i++,a.extraDecisions.length===i&&g&&g()})})}else g&&g()},a.previousChild=function(){a.submit(!1,function(){a.childNdx=_.indexOf(_.pluck(a.children,"Id"),parseInt(b.childId));if(a.childNdx<0){e.previousMenu();return}a.childNdx=a.childNdx-1;var d=a.children[a.childNdx].Id;c.path("/Parenting/Decision/user/"+b.userId+"/child/"+d)})},a.nextChild=function(){a.submit(!1,function(){a.childNdx=_.indexOf(_.pluck(a.children,"Id"),parseInt(b.childId));if(a.childNdx===a.children.length-1){e.nextMenu();return}a.childNdx=a.childNdx+1;var d=a.children[a.childNdx].Id;e.setSubMenuIconClass(a.path,"icon-ok icon-green"),c.path("/Parenting/Decision/user/"+b.userId+"/child/"+d)})},a.copyChild=function(c){a.submit(!1,function(){c===0?_.each(a.children,function(a){a.childId!=b.childId&&h(a.Id)}):h(c)})},a.getChildDecision(b.childId)};DecisionCtrl.$inject=["$scope","$routeParams","$location","decisionService","menuService","genericService","$rootScope"]
...
;var FormCompleteCtrl=function(a,b,c,d,e,f,g,h){function i(){d.formCompletes.get({FormName:b.formName,UserId:b.userId},function(b){b.IncompleteForms.length===0?a.NoErrors=!0:(a.IncompleteForms=b.IncompleteForms,a.NoErrors=!1),a.CheckingFormProgress=!1})}a.storageKey=c.path(),a.formName=b.formName,a.CheckingFormProgress=!0,a.NoErrors=!0,i(),a.submit=function(a){if(!a)switch(b.formName){case"ParentingPlan":c.path("/Output/Parenting/User/"+b.userId);break;case"MediationAgreement":c.path("/Output/DomesticMediation/User/"+b.userId);break;case"FinancialForm":c.path("/Output/ScheduleA/User/"+b.userId);break;case"Starter":e.getMenu(function(){d.child.get({UserId:b.userId},function(a){a.Children.length==0?c.path("/Domestic/House/user/"+b.userId):c.path("/Parenting/Supervision/user/"+b.userId)})})}},h.currentScope=a,g.setTitle("Form Completed")};FormCompleteCtrl.$inject=["$scope","$routeParams","$location","formCompleteService","menuService","genericService","headerService","$rootScope"]
...
;var ParentingCtrl=function(a,b,c,d,e,f,g,h){a.storageKey=c.path(),d.parentings.get({UserId:b.userId},function(b){a.parenting=b}),a.submit=function(){},h.currentScope=a,g.hide()};ParentingCtrl.$inject=["$scope","$routeParams","$location","parentingService","menuService","genericService","headerService","$rootScope"]
;FormsApp.factory("domesticMediationService",["$resource",function(a){var b={domesticMediations:a("/api/output/domesticMediation/",{},{get:{method:"GET",params:{format:"json"}},update:{method:"PUT",params:{format:"json"}}})};return b}])
;var DomesticMediationCtrl=function(a,b,c,d,e,f,g,h){a.storageKey=c.path(),d.domesticMediations.get({UserId:b.userId},function(b){a.domesticMediation=b}),a.submit=function(){},h.currentScope=a,g.hide()};DomesticMediationCtrl.$inject=["$scope","$routeParams","$location","domesticMediationService","menuService","genericService","headerService","$rootScope"]
...
;var ScheduleACtrl=function(a,b,c,d,e,f,g,h){a.storageKey=c.path(),d.scheduleAs.get({UserId:b.userId},function(b){a.scheduleA=b}),a.submit=function(){},h.currentScope=a,g.hide()};ScheduleACtrl.$inject=["$scope","$routeParams","$location","scheduleAService","menuService","genericService","headerService","$rootScope"]
...
;var ScheduleBCtrl=function(a,b,c,d,e,f,g,h){a.storageKey=c.path(),d.scheduleBs.get({UserId:b.userId},function(b){a.scheduleB=b}),a.submit=function(){},h.currentScope=a,g.hide()};ScheduleBCtrl.$inject=["$scope","$routeParams","$location","scheduleBService","menuService","genericService","headerService","$rootScope"]
...
;var ScheduleDCtrl=function(a,b,c,d,e,f,g,h){a.storageKey=c.path(),d.scheduleDs.get({UserId:b.userId},function(b){a.scheduleD=b}),a.submit=function(){},h.currentScope=a,g.hide()};ScheduleDCtrl.$inject=["$scope","$routeParams","$location","scheduleDService","menuService","genericService","headerService","$rootScope"]
...
;var ScheduleECtrl=function(a,b,c,d,e,f,g,h){a.storageKey=c.path(),d.scheduleEs.get({UserId:b.userId},function(b){a.scheduleE=b}),a.submit=function(){},h.currentScope=a,g.hide()};ScheduleECtrl.$inject=["$scope","$routeParams","$location","scheduleEService","menuService","genericService","headerService","$rootScope"]
...
;var ChildSupportOutputCtrl=function(a,b,c,d,e,f,g,h){a.storageKey=c.path(),d.childSupports.get({UserId:b.userId},function(b){a.childSupport=b}),a.submit=function(){},h.currentScope=a,g.hide()};ChildSupportOutputCtrl.$inject=["$scope","$routeParams","$location","childSupportOutputService","menuService","genericService","headerService","$rootScope"]
...
;var CSACtrl=function(a,b,c,d,e,f,g,h){a.storageKey=c.path(),d.csas.get({UserId:b.userId},function(b){a.csa=b}),a.submit=function(){},h.currentScope=a,g.hide()};CSACtrl.$inject=["$scope","$routeParams","$location","csaService","menuService","genericService","headerService","$rootScope"]
;FormsApp.factory("registerAdminService",["$resource",function(a){var b={registerAdmins:a("/api/register/",{},{}),roles:a("/api/userauths/addroles/",{},{})};return b}])
;var RegisterAdminCtrl=function(a,b,c,d,e,f,g,h){a.path=c.path(),a.submit=function(){if(a.registerAdminForm.$invalid){var b=f.getFormInput("#registerAdminForm");$.jStorage.set(a.path,b);return}$.jStorage.deleteKey(a.path),a.user.UserName=a.user.Email.replace("@","_").replace(".","_"),d.registerAdmins.post(null,a.user,function(){var b={UserName:a.Email,Roles:["FirmAdmin","Attorney"]};d.roles.save(null,b,function(){c.path("/")})})},h.currentScope=a,g.setTitle("Register Administrator")};RegisterAdminCtrl.$inject=["$scope","$routeParams","$location","registerAdminService","menuService","genericService","headerService","$rootScope"]
;var HomeCtrl=function(a,b,c,d,e,f){};HomeCtrl.$inject=["$scope","$routeParams","$route","$location","menuService","genericService"]
...
;var HeaderCtrl=function(a,b,c,d,e,f){d.initialize(),a.$watch(function(){return d.Title},function(){a.PageTitle=d.Title},!0),a.$watch(function(){return d.levels},function(){a.levels=d.levels},!0),a.$watch(function(){return d.showHeader},function(){a.showHeader=d.showHeader},!0),a.showIssue=!1,a.showIssueForm=function(){a.showIssue=!a.showIssue},a.submitIssues=function(){a.feedback.Path=c.path(),d.emails.save(null,a.feedback,function(){a.feedbackForm.$setPristine(),a.feedback="",a.showIssue=!1,e.showMessage("Feedback Sent!","Your feedback has been sent and is appreciated! You should hear from us within 48 hours.",Application.properties.messageType.Success)})}};HeaderCtrl.$inject=["$scope","$routeParams","$location","headerService","messageService","$rootScope"]
;FormsApp.factory("headerService",["menuService","$location","$resource",function(a,b,c){var d={menuGroup:null,hide:function(){d.showHeader=!1},show:function(){d.showHeader=!0},emails:c("/api/emails/feedback",{},{get:{method:"GET",params:{format:"json"}},update:{method:"PUT",params:{format:"json"}}}),initialize:function(c){c?d.path=c:d.path=b.path(),d.menuGroup=a.getMenuGroupByPath(d.path),d.showHeader=!0},setTitle:function(a){a?d.Title=a:d.menuGroup&&(d.Title=d.menuGroup.subMenuItem?d.menuGroup.subMenuItem.text:d.menuGroup.menuItem.text),d.showHeader=!0},setBreadCrumbs:function(){d.levels=[],d.menuGroup&&d.menuGroup.menuItem&&(d.levels.push(d.menuGroup.menuItem),d.menuGroup.subMenuItem&&d.levels.push(d.menuGroup.subMenuItem)),d.showHeader=!0},path:null,refresh:function(a){d.initialize(a),d.setTitle(),d.setBreadCrumbs()}};return d}])
...
;FormsApp.factory("loginMenuService",["$resource","menuService",function(a,b){var c={userAuth:a("/api/userauths/",{},{get:{method:"GET",params:{format:"json"}}}),auth:a("/api/auth/logout",{},{logout:{method:"GET",params:{format:"json"}}}),refresh:function(){c.userAuth.get({},function(a){a.UserSession!=null&&(c.authUser=a.UserSession,b.userId=c.authUser.CustomId,b.getMenu())})}};return c}])
...
;FormsApp.factory("logoffService",["loginMenuService","$location",function(a,b){var c={logout:function(){a.auth.logout({},function(){a.refresh(),b.path("/")})}};return c}])
;var UnauthorizedCtrl=function(a,b,c,d,e,f){f.hide()};UnauthorizedCtrl.$inject=["$scope","$routeParams","$location","unauthorizedService","menuService","headerService"]
...
;FormsApp.factory("registerService",["$resource",function(a){var b={register:a("/api/register/",{},{post:{method:"POST",params:{}}}),authUser:null};return b}])
