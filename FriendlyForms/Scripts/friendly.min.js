...
;var ChildCareCtrl=function(a,b,c,d,e,f,g){a.path=c.path(),a.showErrors=!1,a.showMessage=!1,g.currentScope=a,d.children.get({UserId:b.userId},function(c){a.children=c.Children,a.childNdx=_.indexOf(_.pluck(a.children,"Id"),parseInt(b.childId)),a.childName=a.children[a.childNdx].Name}),a.getChildChildCare=function(b){a.childCare=d.childCares.get({ChildId:b},function(){if(typeof a.childCare.Id=="undefined"||a.childCare.Id==0)a.childCare=$.jStorage.get(a.path)})},d.childCareForms.get({UserId:b.userId},function(b){typeof b.Id=="undefined"||b.Id==0?a.childCareForm=$.jStorage.get(a.path):a.childCareForm=b}),a.submit=function(c){if(a.childCareForm.$invalid){e.setSubMenuIconClass(a.path,"icon-pencil icon-red");return}a.childCareForm.UserId=b.userId,typeof a.childCareForm.Id=="undefined"||a.childCareForm.Id==0?d.childCareForms.save(null,a.childCareForm,function(){e.setSubMenuIconClass(a.path,"icon-ok icon-green")}):d.childCareForms.update(null,a.childCareForm,function(){e.setSubMenuIconClass(a.path,"icon-ok icon-green")})},a.submitChildCare=function(c){if(a.childCareChildForm.$invalid||a.childCare===null){e.setSubMenuIconClass(a.path,"icon-pencil icon-red");var g=f.getFormInput("#childCareChildForm");$.jStorage.set(a.path,g),a.showErrors=!0,c&&c();return}$.jStorage.deleteKey(a.path),a.childCare.UserId=b.userId,a.childCare.ChildId=b.childId,typeof a.childCare.Id=="undefined"||a.childCare.Id==0?d.childCares.save(null,a.childCare,function(){c()}):d.childCares.update({Id:a.childCare.Id},a.childCare,function(){c()}),e.setSubMenuIconClass(a.path,"icon-ok icon-green")},a.previousChild=function(){a.submitChildCare(function(){a.childNdx=_.indexOf(_.pluck(a.children,"Id"),parseInt(b.childId));if(a.childNdx===0){e.previousMenu();return}a.childNdx=a.childNdx-1;var d=a.children[a.childNdx].Id;c.path("/Financial/ChildCare/user/"+b.userId+"/child/"+d)})},a.nextChild=function(){a.submitChildCare(function(){if(!a.childCareForm.ChildrenInvolved||a.childCareForm.ChildrenInvolved==2){e.nextMenu();return}a.childNdx=_.indexOf(_.pluck(a.children,"Id"),parseInt(b.childId));if(a.childNdx===a.children.length-1){e.nextMenu();return}a.childNdx=a.childNdx+1;var d=a.children[a.childNdx].Id;e.setSubMenuIconClass(a.path,"icon-ok icon-green"),c.path("/Financial/ChildCare/user/"+b.userId+"/child/"+d)})},a.getChildChildCare(b.childId),f.refreshPage()};ChildCareCtrl.$inject=["$scope","$routeParams","$location","childCareService","menuService","genericService","$rootScope"]
...
;var ExtraExpenseCtrl=function(a,b,c,d,e,f,g){a.path=c.path(),a.showErrors=!1,a.showMessage=!1,g.currentScope=a,d.children.get({UserId:b.userId},function(c){a.children=c.Children,a.childNdx=_.indexOf(_.pluck(a.children,"Id"),parseInt(b.childId)),a.childName=a.children[a.childNdx].Name}),a.getChildExtraExpense=function(b){a.extraExpense=d.extraExpenses.get({ChildId:b},function(){if(typeof a.extraExpense.Id=="undefined"||a.extraExpense.Id==0)a.extraExpense=$.jStorage.get(a.path)})},a.extraExpenseForm=d.extraExpenseForms.get({UserId:b.userId},function(){if(typeof a.extraExpenseForm.Id=="undefined"||a.extraExpenseForm.Id==0)a.showErrors=!0}),a.submit=function(c){if(a.extraExpensesForm.$invalid){e.setSubMenuIconClass(a.path,"icon-pencil icon-red");return}a.extraExpenseForm.UserId=b.userId,typeof a.extraExpenseForm.Id=="undefined"||a.extraExpenseForm.Id==0?d.extraExpenseForms.save(null,a.extraExpenseForm,function(){e.setSubMenuIconClass(a.path,"icon-ok icon-green")}):d.extraExpenseForms.update(null,a.extraExpenseForm,function(){e.setSubMenuIconClass(a.path,"icon-ok icon-green")})},a.submitExtraExpense=function(c){if(a.extraExpenseChildForm.$invalid){e.setSubMenuIconClass(a.path,"icon-pencil icon-red");var g=f.getFormInput("#extraExpenseChildForm");$.jStorage.set(a.path,g),c&&c();return}$.jStorage.deleteKey(a.path),a.extraExpense.UserId=b.userId,a.extraExpense.ChildId=b.childId,typeof a.extraExpense.Id=="undefined"||a.extraExpense.Id==0?d.extraExpenses.save(null,a.extraExpense,function(){c()}):d.extraExpenses.update({Id:a.extraExpense.Id},a.extraExpense,function(){c()}),e.setSubMenuIconClass(a.path,"icon-ok icon-green")},a.previousChild=function(){a.submitExtraExpense(function(){if(!a.extraExpenseForm||!a.extraExpenseForm.HasExtraExpenses||a.extraExpenseForm.HasExtraExpenses==2){e.previousMenu();return}a.childNdx=_.indexOf(_.pluck(a.children,"Id"),parseInt(b.childId));if(a.childNdx===0){e.previousMenu();return}a.childNdx=a.childNdx-1;var d=a.children[a.childNdx].Id;c.path("/Financial/ExtraExpense/user/"+b.userId+"/child/"+d)})},a.nextChild=function(){a.submitExtraExpense(function(){if(!a.extraExpenseForm.HasExtraExpenses||a.extraExpenseForm.HasExtraExpenses==2){e.nextMenu();return}a.childNdx=_.indexOf(_.pluck(a.children,"Id"),parseInt(b.childId));if(a.childNdx===a.children.length-1){e.nextMenu();return}a.childNdx=a.childNdx+1;var d=a.children[a.childNdx].Id;e.setSubMenuIconClass(a.path,"icon-ok icon-green"),c.path("/Financial/ExtraExpense/user/"+b.userId+"/child/"+d)})},a.getChildExtraExpense(b.childId),f.refreshPage()};ExtraExpenseCtrl.$inject=["$scope","$routeParams","$location","extraExpenseService","menuService","genericService","$rootScope"]
...
;var IncomeCtrl=function(a,b,c,d,e,f,g){a.path=c.path(),a.showErrors=!1,a.income=d.incomes.get({UserId:b.userId,IsOtherParent:b.isOtherParent},function(){if(typeof a.income.Id=="undefined"||a.income.Id==0)a.income=$.jStorage.get(a.path),a.income&&(a.showErrors=!0)}),a.submit=function(c){var g=b.isOtherParent;if(a.incomeForm.$invalid){e.setSubMenuIconClass(a.path,"icon-pencil icon-red");var h=f.getFormInput("#incomeForm");$.jStorage.set(a.path,h),c||e.nextMenu();return}$.jStorage.deleteKey(a.path),a.income.UserId=b.userId,a.income.isOtherParent=g,typeof a.income.Id=="undefined"||a.income.Id==0?d.incomes.save(null,a.income,function(){e.setSubMenuIconClass(a.path,"icon-ok icon-green"),c||e.nextMenu()}):d.incomes.update({Id:a.income.Id},a.income,function(){e.setSubMenuIconClass(a.path,"icon-ok icon-green"),c||e.nextMenu()})},g.currentScope=a,f.refreshPage()};IncomeCtrl.$inject=["$scope","$routeParams","$location","incomeService","menuService","genericService","$rootScope"]
...
;var SupportCtrl=function(a,b,c,d,e,f,g){a.path=c.path(),a.showAddChild=!1,a.showErrors=!1,a.support=d.supports.get({UserId:b.userId,IsOtherParent:b.isOtherParent},function(){if(typeof a.support.Id=="undefined"||a.support.Id==0)a.support=$.jStorage.get(a.path),a.support&&(a.showErrors=!0)}),d.courts.get({UserId:b.userId,IsOtherParent:b.isOtherParent},function(b){b.PreexistingSupports.length==0?a.courts=[]:a.courts=b.PreexistingSupports}),a.addCourt=function(){a.court.UserId=b.userId,a.court.IsOtherParent=b.isOtherParent,d.courts.save(null,a.court,function(b){a.courts.push(b),a.courtForm.$setPristine(),a.court=""})},a.showChildren=function(b){d.children.get({PreexistingSupportId:b.Id},function(c){c.Children.length==0?a.children=[]:a.children=c.Children,a.showAddChild=!0,a.PreexistingSupportId=b.Id})},a.addChild=function(){a.child.UserId=b.userId,a.child.PreexistingSupportId=a.PreexistingSupportId,d.children.save(null,a.child,function(b){a.children.push(b.Child),a.childForm.$setPristine(),a.child=""})},a.submit=function(){var c=b.isOtherParent;if(a.supportForm.$invalid){e.setSubMenuIconClass(a.path,"icon-pencil icon-red");var g=f.getFormInput("#supportForm");$.jStorage.set(a.path,g);return}$.jStorage.deleteKey(a.path),a.support.UserId=b.userId,a.support.IsOtherParent=c,typeof a.support.Id=="undefined"||a.support.Id==0?d.supports.save(null,a.support,function(){e.setSubMenuIconClass(a.path,"icon-ok icon-green")}):d.supports.update({Id:a.support.Id},a.support,function(){e.setSubMenuIconClass(a.path,"icon-ok icon-green")})},a.continue=function(){e.nextMenu()},g.currentScope=a,f.refreshPage()};SupportCtrl.$inject=["$scope","$routeParams","$location","supportService","menuService","genericService","$rootScope"]
...
;FormsApp.factory("formCompleteService",["$resource",function(a){var b={formCompletes:a("/api/output/formComplete/",{},{get:{method:"GET",params:{format:"json"}},update:{method:"PUT",params:{format:"json"}}}),child:a("/api/child/",{},{update:{method:"PUT"},deleteAll:{method:"DELETE"}})};return b}])
;var FormCompleteCtrl=function(a,b,c,d,e,f,g,h){function i(){d.formCompletes.get({FormName:b.formName,UserId:b.userId},function(b){b.IncompleteForms.length===0?a.NoErrors=!0:(a.IncompleteForms=b.IncompleteForms,a.NoErrors=!1),a.CheckingFormProgress=!1})}a.storageKey=c.path(),a.formName=b.formName,a.CheckingFormProgress=!0,a.NoErrors=!0,i(),a.isStarter=b.formName=="Starter",a.submit=function(a){if(!a)switch(b.formName){case"ParentingPlan":c.path("/Output/Parenting/User/"+b.userId);break;case"MediationAgreement":c.path("/Output/DomesticMediation/User/"+b.userId);break;case"FinancialForm":c.path("/Output/ScheduleA/User/"+b.userId);break;case"Starter":e.getMenu(function(){d.child.get({UserId:b.userId},function(a){c.path("/Domestic/House/user/"+b.userId)})})}},h.currentScope=a,g.setTitle("Form Completed")};FormCompleteCtrl.$inject=["$scope","$routeParams","$location","formCompleteService","menuService","genericService","headerService","$rootScope"]
...
;var ParentingCtrl=function(a,b,c,d,e,f,g,h){a.storageKey=c.path(),d.parentings.get({UserId:b.userId},function(b){a.parenting=b}),a.submit=function(){},h.currentScope=a,g.hide(),g.showOutputHeader()};ParentingCtrl.$inject=["$scope","$routeParams","$location","parentingService","menuService","genericService","headerService","$rootScope"]
...
;var DomesticMediationCtrl=function(a,b,c,d,e,f,g,h,i){a.storageKey=c.path(),e.domesticMediations.get({UserId:b.userId},function(b){a.domesticMediation=b,d(function(){var a=$("#main-content").html();a=a.replace(/<form.*>/,""),a=a.replace(/<input.*>/g,""),a=a.replace(/<footer[^>]*?>([\s\S]*)<\/footer>/,""),$(".html").val(a)},2e3)}),a.submit=function(){},i.currentScope=a,h.hide(),h.showOutputHeader()};DomesticMediationCtrl.$inject=["$scope","$routeParams","$location","$timeout","domesticMediationService","menuService","genericService","headerService","$rootScope"]
...
;var ScheduleACtrl=function(a,b,c,d,e,f,g,h){a.storageKey=c.path(),d.scheduleAs.get({UserId:b.userId},function(b){a.scheduleA=b}),a.submit=function(){},h.currentScope=a,g.hide(),g.showOutputHeader()};ScheduleACtrl.$inject=["$scope","$routeParams","$location","scheduleAService","menuService","genericService","headerService","$rootScope"]
...
;var ScheduleBCtrl=function(a,b,c,d,e,f,g,h){a.storageKey=c.path(),d.scheduleBs.get({UserId:b.userId},function(b){a.scheduleB=b}),a.submit=function(){},h.currentScope=a,g.hide(),g.showOutputHeader()};ScheduleBCtrl.$inject=["$scope","$routeParams","$location","scheduleBService","menuService","genericService","headerService","$rootScope"]
...
;var ScheduleDCtrl=function(a,b,c,d,e,f,g,h){a.storageKey=c.path(),d.scheduleDs.get({UserId:b.userId},function(b){a.scheduleD=b}),a.submit=function(){},h.currentScope=a,g.hide(),g.showOutputHeader()};ScheduleDCtrl.$inject=["$scope","$routeParams","$location","scheduleDService","menuService","genericService","headerService","$rootScope"]
...
;var ScheduleECtrl=function(a,b,c,d,e,f,g,h){a.storageKey=c.path(),d.scheduleEs.get({UserId:b.userId},function(b){a.scheduleE=b}),a.submit=function(){},h.currentScope=a,g.hide(),g.showOutputHeader()};ScheduleECtrl.$inject=["$scope","$routeParams","$location","scheduleEService","menuService","genericService","headerService","$rootScope"]
...
;var ChildSupportOutputCtrl=function(a,b,c,d,e,f,g,h){a.storageKey=c.path(),d.childSupports.get({UserId:b.userId},function(b){a.childSupport=b}),a.submit=function(){},h.currentScope=a,g.hide(),g.showOutputHeader()};ChildSupportOutputCtrl.$inject=["$scope","$routeParams","$location","childSupportOutputService","menuService","genericService","headerService","$rootScope"]
...
;var CSACtrl=function(a,b,c,d,e,f,g,h){a.storageKey=c.path(),d.csas.get({UserId:b.userId},function(b){a.csa=b}),a.submit=function(){},h.currentScope=a,g.hide(),g.showOutputHeader()};CSACtrl.$inject=["$scope","$routeParams","$location","csaService","menuService","genericService","headerService","$rootScope"]
;FormsApp.factory("registerAdminService",["$resource",function(a){var b={registerAdmins:a("/api/register/",{},{})};return b}])
;var RegisterAdminCtrl=["$scope","$routeParams","$location","registerAdminService","loginMenuService","genericService","userService","headerService","registerService",function(a,b,c,d,e,f,g,h,i){a.submit=function(){a.user.AutoLogin=!0,a.user.UserName=a.user.Email,i.register.save(null,a.user,function(){e.refresh(),g.getUserData().then(function(a){i.users.update(null,{Id:a.CustomId,UserAuthId:a.UserAuthId,LawFirmId:b.lawFirmId},function(){c.path("/Administrator/Agreement/User/"+a.CustomId)})})})},h.setTitle("Register Administrator")}]
...
;FormsApp.factory("headerService",["menuService","$location","$resource",function(a,b,c){var d={menuGroup:null,hide:function(){d.showFeedbackHeader=!1,d.showOutput=!1},show:function(){d.showFeedbackHeader=!0,d.showOutput=!1},showOutputHeader:function(){d.showFeedbackHeader=!1,d.showOutput=!0},hideOutputHeader:function(){d.showOutput=!1},emails:c("/api/emails/feedback",{},{get:{method:"GET",params:{format:"json"}},update:{method:"PUT",params:{format:"json"}}}),initialize:function(c){c?d.path=c:d.path=b.path(),d.menuGroup=a.getMenuGroupByPath(d.path),d.showFeedbackHeader=!0},setTitle:function(a){a?d.Title=a:d.menuGroup&&(d.Title=d.menuGroup.subMenuItem?d.menuGroup.subMenuItem.text:d.menuGroup.menuItem.text),d.showFeedbackHeader=!0},setBreadCrumbs:function(){d.levels=[],d.menuGroup&&d.menuGroup.menuItem&&(d.levels.push(d.menuGroup.menuItem),d.menuGroup.subMenuItem&&d.levels.push(d.menuGroup.subMenuItem)),d.showFeedbackHeader=!0},path:null,refresh:function(a){d.initialize(a),d.setTitle(),d.setBreadCrumbs()}};return d}])
;FormsApp.factory("userService",["$resource","$q",function(a,b){var c={userData:null,users:a("/api/users/",{},{get:{method:"GET",params:{format:"json"}},update:{method:"PUT",params:{format:"json"}}}),userAuth:a("/api/userauths/",{},{get:{method:"GET",params:{format:"json"}}}),roles:a("/api/userauths/addroles/",{},{}),getUserData:function(){var a=b.defer();return c.userAuth.get({},function(b){c.userData=b.UserSession,a.resolve(c.userData)}),a.promise}};return c}])
...
;FormsApp.factory("loginMenuService",["$resource","menuService","userService",function(a,b,c){var d={auth:a("/api/auth/logout",{},{logout:{method:"GET",params:{format:"json"}}}),refresh:function(){c.getUserData().then(function(a){a!=null&&a.IsAuthenticated?(d.authUser=a,b.userId=d.authUser.CustomId,b.getMenu()):(d.authUser=null,b.userId=0,b.getMenu())})}};return d}])
;var LoginCtrl=function(a,b,c,d,e){a.login=function(){d.login.post()},e.setTitle("Login")};LoginCtrl.$inject=["$scope","$routeParams","$location","loginService","headerService"]
;FormsApp.factory("loginService",["$resource",function(a){var b={login:a("/api/auth/credentials/",{},{post:{method:"GET",params:{format:"json"}}}),authUser:null};return b}])
