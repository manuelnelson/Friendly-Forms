...
;FormsApp.filter("dollarAmount",function(){return function(a){var b=a.toFixed(2);return b<0?"-$"+Math.abs(b):"$"+Math.abs(b)}})
...
;var ParentingCtrl=["$scope","$routeParams","$rootScope","parentingService","menuService","genericService","headerService","$timeout","$location",function(a,b,c,d,e,f,g,h,i){a.showPrintButton=!1,a.isLoaded=!1,d.parentings.get({UserId:b.userId},function(b){a.parenting=b,a.isLoaded=!0,h(function(){var b=$(".widget-content").html();b=b.replace(/<form.*>/,""),b=b.replace(/<input.*>/g,""),b=b.replace(/<footer[^>]*?>([\s\S]*)<\/footer>/,""),$(".html").val(b),$(".name").val("Parenting"),g.showOutputHeader(),a.showPrintButton=!0},2500)}),a.submit=function(a){var b=e.getMenuGroupByPath(i.path());b.subMenuItem.iconClass=""},c.currentScope=a,g.hide()}]
...
;var ScheduleACtrl=["$scope","$routeParams","$rootScope","scheduleAService","menuService","genericService","headerService","$timeout","$location",function(a,b,c,d,e,f,g,h,i){a.showPrintButton=!1,a.isLoaded=!1,d.scheduleAs.get({UserId:b.userId},function(b){b.Income.OtherDetails||(b.Income.OtherDetails="There is no reason for having other income."),b.OtherIncome.OtherDetails||(b.Income.OtherDetails="There is no reason for having other income."),a.scheduleA=b,a.isLoaded=!0,h(function(){var b=$(".widget-content").html();b=b.replace(/<form.*>/,""),b=b.replace(/<input.*>/g,""),b=b.replace(/<footer[^>]*?>([\s\S]*)<\/footer>/,""),$(".html").val(b),$(".name").val("ScheduleA"),g.showOutputHeader(),a.showPrintButton=!0},2500)}),a.submit=function(a){var b=e.getMenuGroupByPath(i.path());b.subMenuItem.iconClass=""},c.currentScope=a,g.hide()}]
...
;var ScheduleDCtrl=["$scope","$routeParams","$rootScope","scheduleDService","menuService","genericService","headerService","$timeout","$location",function(a,b,c,d,e,f,g,h,i){a.showPrintButton=!1,a.isLoaded=!1,d.scheduleDs.get({UserId:b.userId},function(b){a.scheduleD=b,a.isLoaded=!0,h(function(){var b=$(".widget-content").html();b=b.replace(/<form.*>/,""),b=b.replace(/<input.*>/g,""),b=b.replace(/<footer[^>]*?>([\s\S]*)<\/footer>/,""),$(".html").val(b),$(".name").val("ScheduleD"),g.showOutputHeader(),a.showPrintButton=!0},2500)}),a.submit=function(a){var b=e.getMenuGroupByPath(i.path());b.subMenuItem.iconClass=""},c.currentScope=a,g.hide()}]
...
;var ScheduleECtrl=["$scope","$routeParams","$rootScope","scheduleEService","menuService","genericService","headerService","$timeout","$location",function(a,b,c,d,e,f,g,h,i){a.showPrintButton=!1,a.isLoaded=!1,d.scheduleEs.get({UserId:b.userId},function(b){a.scheduleE=b,a.isLoaded=!0,h(function(){var b=$(".widget-content").html();b=b.replace(/<form.*>/,""),b=b.replace(/<input.*>/g,""),b=b.replace(/<footer[^>]*?>([\s\S]*)<\/footer>/,""),$(".html").val(b),$(".name").val("ScheduleE"),g.showOutputHeader(),a.showPrintButton=!0},2500)}),a.submit=function(a){var b=e.getMenuGroupByPath(i.path());b.subMenuItem.iconClass=""},c.currentScope=a,g.hide()}]
