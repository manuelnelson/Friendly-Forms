...
;var RegisterAdminCtrl=["$scope","$routeParams","$location","registerAdminService","loginMenuService","genericService","userService","headerService","registerService",function(a,b,c,d,e,f,g,h,i){a.submit=function(){a.user.AutoLogin=!0,a.user.UserName=a.user.Email,i.register.save(null,a.user,function(){e.refresh(),g.getCurrentUserSession().then(function(a){i.users.update(null,{Id:a.CustomId,UserAuthId:a.UserAuthId,LawFirmId:b.lawFirmId},function(){c.path("/Administrator/Agreement/User/"+a.CustomId)})})})},h.setTitle("Register Administrator")}]
...
;var CreateAttorneyCtrl=["$scope","$routeParams","$location","createAttorneyService","menuService","headerService","registerService","userService",function(a,b,c,d,e,f,g,h){a.submit=function(){a.user.UserName=a.user.Email,g.register.save(null,a.user,function(){h.getCurrentUserSession().then(function(d){g.users.update(null,{Id:d.CustomId,UserAuthId:d.UserAuthId,LawFirmId:b.lawFirmId,Position:a.user.Position},function(){h.roles.save(null,{UserName:d.UserName,Roles:["Lawyer"]},function(){c.path("/Administrator/Agreement/User/"+d.CustomId)})})})})},f.setTitle("Register Administrator")}]
...
;FormsApp.factory("userService",["$resource","$q",function(a,b){var c={userData:null,users:a("/api/users/",{},{get:{method:"GET",params:{format:"json"}},update:{method:"PUT",params:{format:"json"}}}),userAuth:a("/api/userauths/",{},{get:{method:"GET",params:{format:"json"}}}),roles:a("/api/userauths/addroles/",{},{}),getCurrentUserSession:function(){var a=b.defer();return c.userAuth.get({},function(b){c.userData=b.UserSession,a.resolve(c.userData)}),a.promise}};return c}])
